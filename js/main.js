(() => {
    var q = { autoSleep: 120, force3D: "auto", nullTargetWarn: 1, units: { lineHeight: "" } },
        ...
        $i,
        es = (s) => (wt = Qe(s, te)) && oe,
        Tt = (s, e) => console.warn("Invalid property", s, "set to", e, "Missing plugin? gsap.registerPlugin()"),
        ...
        ai = (s) => {
            ...
            for (i = s.length; i--; ) (s[i] && (s[i]._gsap || (s[i]._gsap = new Rt(s[i], t)))) || s.splice(i, 1);
            return s;
        },
        Ee = (s) => s._gsap || ai(xe(s))[0]._gsap,
        ni = (s, e, t) => ((t = s[e]) && W(t) ? s[e]() : (bt(t) && s.getAttribute && s.getAttribute(e)) || t),
        ...
        dt = (s, e, t) => {
            ...
            if ((i && (a.duration = s[1]), (a.parent = t), e)) {
                for (n = a; t && !("immediateRender" in n); ) (n = t.vars.defaults || {}), (t = Z(t.vars.inherit) && t.parent);
                (a.immediateRender = Z(n.immediateRender)), e < 2 ? (a.runBackwards = 1) : (a.startAt = s[r - 1]);
            }
            return a;
        },
        St = () => {
            let s = Me.length,
                ...
                t,
                i;
            for (ii = {}, Me.length = 0, t = 0; t < s; t++) (i = e[t]), i && i._lazy && (i.render(i._lazy[0], i._lazy[1], !0)._lazy = 0);
        },
        as = (s, e, t, i) => {
        ...
        oi = (s, e) => {
            for (let t in e) t !== "__proto__" && t !== "constructor" && t !== "prototype" && (s[t] = Te(e[t]) ? oi(s[t] || (s[t] = {}), e[t]) : e[t]);
            return s;
        },
        hi = (s, e) => {
            let t = {},
        ...
        Or = (s, e, t = "_first", i = "_last", r) => {
            ...
            return a ? ((e._next = a._next), (a._next = e)) : ((e._next = s[t]), (s[t] = e)), e._next ? (e._next._prev = e) : (s[i] = e), (e._prev = a), (e.parent = e._dp = s), e;
        },
        Mt = (s, e, t = "_first", i = "_last") => {
            let r = e._prev,
                a = e._next;
            r ? (r._next = a) : s[t] === e && (s[t] = a), a ? (a._prev = r) : s[i] === e && (s[i] = r), (e._next = e._prev = e.parent = null);
        },
        De = (s, e) => {
        ...
        Et = (s, e) => (s - e._start) * e._ts + (e._ts >= 0 ? 0 : e._dirty ? e.totalDuration() : e._tDur),
        li = (s) => (s._end = S(s._start + (s._tDur / Math.abs(s._ts || s._rts || D) || 0))),
        ds = (s, e) => {
            let t = s._dp;
            return t && t.smoothChildTiming && s._ts && ((s._start = S(t._time - (s._ts > 0 ? e / s._ts : ((s._dirty ? s.totalDuration() : s._tDur) - e) / -s._ts))), li(s), t._dirty || Ne(t, s)), s;
        },
        Dt = (s, e) => {
            let t;
            if (((e._time || (e._initted && !e._dur)) && ((t = Et(s.rawTime(), e)), (!e._dur || ut(0, e.totalDuration(), t) - e._tTime > D) && e.render(t, !0)), Ne(s, e)._dp && s._initted && s._time >= s._dur && s._ts)) {
                if (s._dur < s.duration()) for (t = s; t._dp; ) t.rawTime() >= 0 && t.totalTime(t._tTime), (t = t._dp);
                s._zTime = -D;
            }
        },
        Pe = (s, e, t, i) => (
            e.parent && De(e), (e._start = S(t + e._delay)), (e._end = S(e._start + (e.totalDuration() / Math.abs(e.timeScale()) || 0))), Or(s, e, "_first", "_last", s._sort ? "_start" : 0), (s._recent = e), i || Dt(s, e), s
        ),
        us = (s, e) => (te.ScrollTrigger || Tt("scrollTrigger", e)) && te.ScrollTrigger.create(e, s),
        fs = (s, e, t, i) => {
            if ((cs(s, e), !s._initted)) return 1;
            if (!t && s._pt && ((s._dur && s.vars.lazy !== !1) || (!s._dur && s.vars.lazy)) && ss !== ie.frame) return Me.push(s), (s._lazy = [e, i]), 1;
        },
        ps = ({ parent: s }) => s && s._ts && s._initted && !s._lock && (s.rawTime() < 0 || ps(s)),
        Vr = (s, e, t, i) => {
            let r = s.ratio,
                a = e < 0 || (!e && ((!s._start && ps(s)) || ((s._ts < 0 || s._dp._ts < 0) && s.data !== "isFromStart" && s.data !== "isStart"))) ? 0 : 1,
                n = s._rDelay,
                o = 0,
                l,
                h,
                d;
            if (
                (n && s._repeat && ((o = ut(0, s._tDur, e)), (h = Ze(o, n)), (d = Ze(s._tTime, n)), s._yoyo && h & 1 && (a = 1 - a), h !== d && ((r = 1 - a), s.vars.repeatRefresh && s._initted && s.invalidate())),
                a !== r || i || s._zTime === D || (!e && s._zTime))
            ) {
                if (!s._initted && fs(s, e, i, t)) return;
                for (d = s._zTime, s._zTime = e || (t ? D : 0), t || (t = e && !d), s.ratio = a, s._from && (a = 1 - a), s._time = 0, s._tTime = o, t || se(s, "onStart"), l = s._pt; l; ) l.r(a, l.d), (l = l._next);
                s._startAt && e < 0 && s._startAt.render(e, !0, !0),
                    s._onUpdate && !t && se(s, "onUpdate"),
                    o && s._repeat && !t && s.parent && se(s, "onRepeat"),
                    (e >= s._tDur || e < 0) && s.ratio === a && (a && De(s, 1), t || (se(s, a ? "onComplete" : "onReverseComplete", !0), s._prom && s._prom()));
        ...
        Ke = (s, e, t, i) => {
            let r = s._repeat,
                a = S(e) || 0,
                n = s._tTime / s._tDur;
            return n && !i && (s._time *= a / s._dur), (s._dur = a), (s._tDur = r ? (r < 0 ? 1e10 : S(a * (r + 1) + s._rDelay * r)) : a), n && !i ? ds(s, (s._tTime = s._tDur * n)) : s.parent && li(s), t || Ne(s.parent, s), s;
        },
            ...
            return j(e) && (isNaN(e) || e in t)
                ? ((a = e.charAt(0)),
                  a === "<" || a === ">"
                      ...
                      : ((a = e.indexOf("=")), a < 0 ? (e in t || (t[e] = r), t[e]) : ((n = +(e.charAt(a - 1) + e.substr(a + 1))), a > 1 ? H(s, e.substr(0, a - 1)) + n : r + n)))
                : e == null
                ? r
                : +e;
        },
        ...
        di = [].slice,
        _s = (s, e) => s && Te(s) && "length" in s && ((!e && !s.length) || (s.length - 1 in s && Te(s[0]))) && !s.nodeType && s !== me,
        Br = (s, e, t = []) => s.forEach((i) => ((j(i) && !e) || _s(i, 1) ? t.push(...xe(i)) : t.push(i))) || t,
        xe = (s, e) => (j(s) && !e && (ei || !Je()) ? di.call(Ji.querySelectorAll(s), 0) : ne(s) ? Br(s, e) : _s(s) ? di.call(s, 0) : s ? [s] : []),
        ...
        ys = (s) => {
            ...
            let e = Te(s) ? s : { each: s },
                ...
                d = i;
            return (
                j(i) ? (h = d = { center: 0.5, edges: 0.5, end: 1 }[i] || 0) : !n && o && ((h = i[0]), (d = i[1])),
                (c, p, f) => {
                    let u = (f || e).length,
                        g = a[u],
                        _,
                    ...
                    if (!g) {
                        ...
                        for (g = a[u] = [], _ = o ? Math.min(P, u) * h - 0.5 : i % P, v = o ? (u * d) / P - 0.5 : (i / P) | 0, w = 0, b = _e, y = 0; y < u; y++)
                            (x = (y % P) - _), (T = v - ((y / P) | 0)), (g[y] = m = l ? Math.abs(l === "y" ? T : x) : Yi(x * x + T * T)), m > w && (w = m), m < b && (b = m);
                        i === "random" && ms(g),
                            (g.max = w - b),
                            (g.min = b),
        ...
        vs = (s, e) => {
            let t = ne(s),
                ...
                r;
            return (
                !t && Te(s) && ((i = t = s.radius || _e), s.values ? ((s = xe(s.values)), (r = !ue(s[0])) && (i *= i)) : (s = ui(s.increment))),
                Le(
                    e,
                    t
                        ? W(s)
                            ...
                            : (a) => {
                                  let n = parseFloat(r ? a.x : a),
                                      ...
                                      c,
                                      p;
                                  for (; d--; ) r ? ((c = s[d].x - n), (p = s[d].y - o), (c = c * c + p * p)) : (c = Math.abs(s[d] - n)), c < l && ((l = c), (h = d));
        ...
        bs = (s, e, t, i) =>
            Le(ne(s) ? !e : t === !0 ? !!(t = 0) : !i, () =>
                ne(s) ? s[~~(Math.random() * s.length)] : (t = t || 1e-5) && (i = t < 1 ? 10 ** ((t + "").length - 2) : 1) && Math.floor(Math.round((s - t / 2 + Math.random() * (e - s + t * 0.99)) / t) * t * i) / i
            ),
        Nr = (...s) => (e) => s.reduce((t, i) => i(t), e),
        ...
        Rs = (s, e, t) => {
            let i = e - s,
                r = i * 2;
            return ne(s) ? Ts(s, Rs(0, s.length - 1), e) : Le(t, (a) => ((a = (r + ((a - s) % r)) % r || 0), s + (a > i ? r - a : a)));
        },
        ct = (s) => {
            let e = 0,
                t = "",
            ...
            for (; ~(i = s.indexOf("random(", e)); )
                (a = s.indexOf(")", i)), (n = s.charAt(i + 7) === "["), (r = s.substr(i + 7, a - i - 7).match(n ? Ki : Zt)), (t += s.substr(e, i - e) + bs(n ? r : +r[0], n ? 0 : +r[1], +r[2] || 1e-5)), (e = a + 1);
        ...
        se = (s, e, t) => {
            let i = s.vars,
                ...
                a,
                n;
            if (!!r) return (a = i[e + "Params"]), (n = i.callbackScope || s), t && Me.length && St(), a ? r.apply(n, a) : r.call(n);
        },
        ...
        Xr = (s) => {
            ...
            if ((Je(), s !== i)) {
                if (K[e]) return;
                he(i, he(hi(s, r), a)), Qe(i.prototype, Qe(r, hi(s, a))), (K[(i.prop = e)] = i), s.targetTest && (Pt.push(i), (ti[e] = 1)), (e = (e === "css" ? "CSS" : e.charAt(0).toUpperCase() + e.substr(1)) + "Plugin");
            }
        ...
        pi = (s, e, t) => ((s = s < 0 ? s + 1 : s > 1 ? s - 1 : s), ((s * 6 < 1 ? e + (t - e) * s * 6 : s < 0.5 ? t : s * 3 < 2 ? e + (t - e) * (2 / 3 - s) * 6 : e) * O + 0.5) | 0),
        Ms = (s, e, t) => {
            ...
            if (!i) {
                if ((s.substr(-1) === "," && (s = s.substr(0, s.length - 1)), pt[s])) i = pt[s];
                    ...
                    if ((s.length < 6 && ((r = s.charAt(1)), (a = s.charAt(2)), (n = s.charAt(3)), (s = "#" + r + r + a + a + n + n + (s.length === 5 ? s.charAt(4) + s.charAt(4) : ""))), s.length === 9))
                        return (i = parseInt(s.substr(1, 6), 16)), [i >> 16, (i >> 8) & O, i & O, parseInt(s.substr(7), 16) / 255];
            ...
            return (
                e &&
                    ...
                    (c = Math.min(r, a, n)),
                    (h = (d + c) / 2),
                    d === c ? (o = l = 0) : ((p = d - c), (l = h > 0.5 ? p / (2 - d - c) : p / (d + c)), (o = d === r ? (a - n) / p + (a < n ? 6 : 0) : d === a ? (n - r) / p + 2 : (r - a) / p + 4), (o *= 60)),
                    (i[0] = ~~(o + 0.5)),
                    (i[1] = ~~(l * 100 + 0.5)),
                    (i[2] = ~~(h * 100 + 0.5))),
                t && i.length < 4 && (i[3] = 1),
        ...
        Ds = (s, e, t) => {
            let i = "",
                ...
                d;
            if (!r) return s;
            if (((r = r.map((c) => (c = Ms(c, e, 1)) && a + (e ? c[0] + "," + c[1] + "%," + c[2] + "%," + c[3] : c.join(",")) + ")")), t && ((h = Es(s)), (o = t.c), o.join(i) !== h.c.join(i))))
                for (l = s.replace(tt, "1").split(Be), d = l.length - 1; n < d; n++) i += l[n] + (~o.indexOf(n) ? r.shift() || a + "0,0,0,0)" : (h.length ? h : r.length ? r : t).shift());
        ...
        gi = (s) => {
            let e = s.join(" "),
                t;
            if (((tt.lastIndex = 0), tt.test(e))) return (t = Yr.test(e)), (s[1] = Ds(s[1], t)), (s[0] = Ds(s[0], t, Es(s[1]))), !0;
        },
        At,
        ie = (function () {
            let s = Date.now,
                ...
                u = (g) => {
                    let _ = s() - r,
                        ...
                        m,
                        y;
                    if ((_ > e && (i += _ - t), (r += _), (m = r - i), (x = m - n), (x > 0 || v) && ((y = ++c.frame), (p = m - c.time * 1e3), (c.time = m = m / 1e3), (n += x + (x >= a ? 4 : a - x)), (T = 1)), v || (l = h(u)), T))
        ...
        Zr = (s) => {
            let e = {},
                ...
                o,
                l;
            for (; r < a; r++) (o = t[r]), (n = r !== a - 1 ? o.lastIndexOf(",") : o.length), (l = o.substr(0, n)), (e[i] = isNaN(l) ? l.replace(Qr, "").trim() : +l), (i = o.substr(n + 1).trim());
            return e;
        },
        Kr = (s) => {
            let e = s.indexOf("(") + 1,
        ...
        kt = (s, e) => {
            let t = s._first,
                i;
            for (; t; ) t instanceof G ? kt(t, e) : t.vars.yoyoEase && (!t._yoyo || !t._repeat) && t._yoyo !== e && (t.timeline ? kt(t.timeline, e) : ((i = t._ease), (t._ease = t._yEase), (t._yEase = i), (t._yoyo = e))), (t = t._next);
        },
        $e = (s, e) => (s && (W(s) ? s : Y[s] || Jr(s))) || e,
        We = (s, e, t = (r) => 1 - e(1 - r), i = (r) => (r < 0.5 ? e(r * 2) / 2 : 1 - e((1 - r) * 2) / 2)) => {
            let r = { easeIn: e, easeOut: t, easeInOut: i },
                a;
            return (
                J(s, (n) => {
                    (Y[n] = te[n] = r), (Y[(a = n.toLowerCase())] = t);
                    for (let o in r) Y[a + (o === "easeIn" ? ".in" : o === "easeOut" ? ".out" : ".inOut")] = Y[n + "." + o] = r[o];
                }),
                r
            );
        },
    ...
    ((s, e) => {
        let t = 1 / e,
            i = 2 * t,
            r = 2.5 * t,
            a = (n) => (n < t ? s * n * n : n < i ? s * (n - 1.5 / e) ** 2 + 0.75 : n < r ? s * (n -= 2.25 / e) * n + 0.9375 : s * (n - 2.625 / e) ** 2 + 0.984375);
    ...
    var Rt = class {
            constructor(e, t) {
                (this.id = Cr++), (e._gsap = this), (this.target = e), (this.harness = t), (this.get = t ? t.get : ni), (this.set = t ? t.getSetter : Lt);
            }
        },
        it = class {
            constructor(e, t) {
                ...
                (this.vars = e),
                    ...
                    (this._repeat = e.repeat === Infinity ? -2 : e.repeat || 0) && ((this._rDelay = e.repeatDelay || 0), (this._yoyo = !!e.yoyo || !!e.yoyoEase)),
                    (this._ts = 1),
            ...
            totalTime(e, t) {
                ...
                if (i && i.smoothChildTiming && this._ts) {
                    for (ds(this, e), !i._dp || i.parent || Dt(i, this); i.parent; ) i.parent._time !== i._start + (i._ts >= 0 ? i._tTime / i._ts : (i.totalDuration() - i._tTime) / -i._ts) && i.totalTime(i._tTime, !0), (i = i.parent);
                ...
                return (this._tTime !== e || (!this._dur && !t) || (this._initted && Math.abs(this._zTime) === D) || (!e && !this._initted && (this.add || this._ptLookup))) && (this._ts || (this._pTime = e), as(this, e, t)), this;
            }
            time(e, t) {
            ...
            timeScale(e) {
                ...
                return (this._rts = +e || 0), (this._ts = this._ps || e === -D ? 0 : this._rts), Fr(this.totalTime(ut(-this._delay, this._tDur, t), !0));
            }
            paused(e) {
            ...
            repeat(e) {
                return arguments.length ? ((this._repeat = e === Infinity ? -2 : e), gs(this)) : this._repeat === -2 ? Infinity : this._repeat;
            }
            repeatDelay(e) {
            ...
            eventCallback(e, t, i) {
                let r = this.vars;
                return arguments.length > 1 ? (t ? ((r[e] = t), i && (r[e + "Params"] = i), e === "onUpdate" && (this._onUpdate = t)) : delete r[e], this) : r[e];
            }
            then(e) {
                let t = this;
                return new Promise((i) => {
                    let r = W(e) ? e : os,
                        a = () => {
                            let n = t.then;
                            (t.then = null), W(r) && (r = r(t)) && (r.then || r === t) && (t.then = n), i(r), (t.then = n);
                        };
    ...
    he(it.prototype, { _time: 0, _start: 0, _end: 0, _tTime: 0, _tDur: 0, _dirty: 0, _repeat: 0, _yoyo: !1, parent: null, _initted: !1, _rDelay: 0, _ts: 1, _dp: 0, ratio: 0, _zTime: -D, _prom: 0, _ps: !1, _rts: 1 });
    var G = class extends it {
        ...
        set(e, t, i) {
            return (t.duration = 0), (t.parent = this), Ct(t).repeatDelay || (t.repeat = 0), (t.immediateRender = !!t.immediateRender), new L(e, t, H(this, i), 1), this;
        }
        call(e, t, i) {
            return Pe(this, L.delayedCall(0, e, t), H(this, i));
        }
        staggerTo(e, t, i, r, a, n, o) {
            return (i.duration = t), (i.stagger = i.stagger || r), (i.onComplete = n), (i.onCompleteParams = o), (i.parent = this), new L(e, i, H(this, a)), this;
        }
        staggerFrom(e, t, i, r, a, n, o) {
            return (i.runBackwards = 1), (Ct(i).immediateRender = Z(i.immediateRender)), this.staggerTo(e, t, i, r, a, n, o);
        }
        staggerFromTo(e, t, i, r, a, n, o, l) {
            return (r.startAt = i), (Ct(r).immediateRender = Z(r.immediateRender)), this.staggerTo(e, t, r, a, n, o, l);
        }
        render(e, t, i) {
            let r = this._time,
            ...
            if (o !== this._tTime || i || l) {
                if ((r !== this._time && n && ((o += this._time - r), (e += this._time - r)), (h = o), (v = this._start), (_ = this._ts), (u = !_), l && (n || (r = this._zTime), (e || !t) && (this._zTime = e)), this._repeat)) {
                    if (((T = this._yoyo), (f = n + this._rDelay), this._repeat < -1 && e < 0)) return this.totalTime(f * 100 + e, t, i);
                    if (
                        ((h = S(o % f)),
                        o === a ? ((p = this._repeat), (h = n)) : ((p = ~~(o / f)), p && p === o / f && ((h = n), p--), h > n && (h = n)),
                        (x = Ze(this._tTime, f)),
                        ...
                        if (
                            ...
                            return this;
                        if (((n = this._dur), (a = this._tDur), w && ((this._lock = 2), (r = y ? n : -1e-4), this.render(r, !0), this.vars.repeatRefresh && !m && this.invalidate()), (this._lock = 0), !this._ts && !u)) return this;
                        kt(this, m);
                    }
                }
                if (
                    (this._hasPause && !this._forcing && this._lock < 2 && ((g = zr(this, S(r), S(h))), g && (o -= h - (h = g._start))),
                    (this._tTime = o),
                    (this._time = h),
                    (this._act = !_),
                    this._initted || ((this._onUpdate = this.vars.onUpdate), (this._initted = 1), (this._zTime = e), (r = 0)),
                    ...
                    for (d = this._first; d; ) {
                        if (((c = d._next), (d._act || h >= d._start) && d._ts && g !== d)) {
                            ...
                            if ((d.render(d._ts > 0 ? (h - d._start) * d._ts : (d._dirty ? d.totalDuration() : d._tDur) + (h - d._start) * d._ts, t, i), h !== this._time || (!this._ts && !u))) {
                    ...
                    for (; d; ) {
                        if (((c = d._prev), (d._act || y <= d._end) && d._ts && g !== d)) {
                            if (d.parent !== this) return this.render(e, t, i);
                            if ((d.render(d._ts > 0 ? (y - d._start) * d._ts : (d._dirty ? d.totalDuration() : d._tDur) + (y - d._start) * d._ts, t, i), h !== this._time || (!this._ts && !u))) {
                ...
                if (g && !t && (this.pause(), (g.render(h >= r ? 0 : -D)._zTime = h >= r ? 1 : -1), this._ts)) return (this._start = v), li(this), this.render(e, t, i);
                this._onUpdate && !t && se(this, "onUpdate", !0),
                    ((o === a && a >= this.totalDuration()) || (!o && r)) &&
                        ...
                        (this._lock ||
                            ...
                            !t && !(e < 0 && !r) && (o || r) && (se(this, o === a ? "onComplete" : "onReverseComplete", !0), this._prom && !(o < a && this.timeScale() > 0) && this._prom())));
            }
            return this;
        }
        add(e, t) {
        ...
        getChildren(e = !0, t = !0, i = !0, r = -_e) {
            let a = [],
                n = this._first;
            for (; n; ) n._start >= r && (n instanceof L ? t && a.push(n) : (i && a.push(n), e && a.push(...n.getChildren(!0, t, i)))), (n = n._next);
            return a;
        }
        getById(e) {
        ...
        remove(e) {
            return j(e) ? this.removeLabel(e) : W(e) ? this.killTweensOf(e) : (Mt(this, e), e === this._recent && (this._recent = this._last), Ne(this));
        }
        totalTime(e, t) {
            return arguments.length
                ? ((this._forcing = 1), !this._dp && this._ts && (this._start = S(ie.time - (this._ts > 0 ? e / this._ts : (this.totalDuration() - e) / -this._ts))), super.totalTime(e, t), (this._forcing = 0), this)
                : this._tTime;
        }
        addLabel(e, t) {
            ...
            if (i._dirty) {
                for (l = i.parent; r; )
                    (n = r._prev),
                        ...
                        (o = r._start),
                        o > a && i._sort && r._ts && !i._lock ? ((i._lock = 1), (Pe(i, r, o - r._delay, 1)._lock = 0)) : (a = o),
                        o < 0 && r._ts && ((t -= o), ((!l && !i._dp) || (l && l.smoothChildTiming)) && ((i._start += o / i._ts), (i._time -= o), (i._tTime -= o)), i.shiftChildren(-o, !1, -Infinity), (a = 0)),
    ...
    var $r = function (s, e, t, i, r, a, n) {
            let o = new X(this._pt, s, e, 0, 1, _i, null, r),
                ...
                _,
                v;
            for (o.b = t, o.e = i, t += "", i += "", (_ = ~i.indexOf("random(")) && (i = ct(i)), a && ((v = [t, i]), a(v, s, e), (t = v[0]), (i = v[1])), c = t.match(Jt) || []; (d = Jt.exec(i)); )
                (f = d[0]),
                    (u = i.substring(l, d.index)),
                    p ? (p = (p + 1) % 5) : u.substr(-5) === "rgba(" && (p = 1),
                    f !== c[h++] &&
                        ((g = parseFloat(c[h - 1]) || 0),
                        (o._pt = { _next: o._pt, p: u || h === 1 ? u : ",", s: g, c: f.charAt(1) === "=" ? parseFloat(f.substr(2)) * (f.charAt(0) === "-" ? -1 : 1) : parseFloat(f) - g, m: p && p < 4 ? Math.round : 0 }),
                        (l = Jt.lastIndex));
            return (o.c = l < i.length ? i.substring(l, i.length) : ""), (o.fp = n), ($t.test(i) || _) && (o.e = 0), (this._pt = o), o;
        },
        ci = function (s, e, t, i, r, a, n, o, l) {
            W(i) && (i = i(r || 0, s, a));
            let h = s[e],
                d = t !== "get" ? t : W(h) ? (l ? s[e.indexOf("set") || !W(s["get" + e.substr(3)]) ? e : "get" + e.substr(3)](l) : s[e]()) : h,
                c = W(h) ? (l ? ea : As) : mi,
                p;
            if ((j(i) && (~i.indexOf("random(") && (i = ct(i)), i.charAt(1) === "=" && (i = parseFloat(d) + parseFloat(i.substr(2)) * (i.charAt(0) === "-" ? -1 : 1) + ($(d) || 0))), d !== i))
                return isNaN(d * i)
                    ? (!h && !(e in s) && Tt(e, i), $r.call(this, s, e, d, i, c, o || q.stringFilter, l))
                    : ((p = new X(this._pt, s, e, +d || 0, i - (d || 0), typeof h == "boolean" ? ta : ks, 0, c)), l && (p.fp = l), n && p.modifier(n, this, s), (this._pt = p));
        },
        ia = (s, e, t, i, r) => {
            if ((W(s) && (s = gt(s, r, e, t, i)), !Te(s) || (s.style && s.nodeType) || ne(s) || Zi(s))) return j(s) ? gt(s, r, e, t, i) : s;
            let a = {},
                n;
        ...
        xi = (s, e, t, i, r, a) => {
            let n, o, l, h;
            if (K[s] && (n = new K[s]()).init(r, n.rawVars ? e[s] : ia(e[s], i, r, a, t), t, i, a) !== !1 && ((t._pt = o = new X(t._pt, r, s, 0, 1, n.render, n, 0, n.priority)), t !== et))
        ...
        cs = (s, e) => {
            let t = s.vars,
                { ease: i, startAt: r, immediateRender: a, lazy: n, onUpdate: o, onUpdateParams: l, callbackScope: h, runBackwards: d, yoyoEase: c, keyframes: p, autoRevert: f } = t,
                u = s._dur,
                g = s._startAt,
                _ = s._targets,
                v = s.parent,
                ...
                M,
                fe;
            if ((m && (!p || !i) && (i = "none"), (s._ease = $e(i, qe.ease)), (s._yEase = c ? xs($e(c === !0 ? i : c, qe.ease)) : 0), c && s._yoyo && !s._repeat && ((c = s._yEase), (s._yEase = s._ease), (s._ease = c)), !m)) {
                if (((I = _[0] ? Ee(_[0]).harness : 0), (M = I && t[I.prop]), (y = hi(t, ti)), g && g.render(-1, !0).kill(), r)) {
                    if ((De((s._startAt = L.set(_, he({ data: "isStart", overwrite: !1, parent: v, immediateRender: !0, lazy: Z(n), startAt: null, delay: 0, onUpdate: o, onUpdateParams: l, callbackScope: h, stagger: 0 }, r)))), a)) {
                    ...
                    if (g) !f && (s._startAt = 0);
                    else if ((e && (a = !1), (b = he({ overwrite: !1, data: "isFromStart", lazy: a && Z(n), immediateRender: a, stagger: 0, parent: v }, y)), M && (b[I.prop] = M), De((s._startAt = L.set(_, b))), !a)) cs(s._startAt, D);
                    else if (!e) return;
                }
                for (s._pt = 0, n = (u && Z(n)) || (n && !u), w = 0; w < _.length; w++) {
                    if (
                        ...
                        for (b in y) K[b] && (k = xi(b, y, s, V, C, x)) ? k.priority && (E = 1) : (U[b] = P = ci.call(s, C, b, "get", y[b], V, x, 0, t.stringFilter));
                    s._op && s._op[w] && s.kill(C, s._op[w]), T && s._pt && ((Ae = s), B.killTweensOf(C, U, s.globalTime(0)), (fe = !s.parent), (Ae = 0)), s._pt && n && (ii[F.id] = 1);
                }
                E && yi(s), s._onInit && s._onInit(s);
            }
            (s._from = !m && !!t.runBackwards), (s._onUpdate = o), (s._initted = (!s._op || s._pt) && !fe);
        },
        sa = (s, e) => {
        ...
        L = class extends it {
            constructor(e, t, i, r) {
                ...
                let { duration: a, delay: n, immediateRender: o, stagger: l, overwrite: h, keyframes: d, defaults: c, scrollTrigger: p, yoyoEase: f } = this.vars,
                    u = this.parent,
                    ...
                    w,
                    b;
                if (((this._targets = g.length ? ai(g) : ts("GSAP target " + e + " not found. https://greensock.com", !q.nullTargetWarn) || []), (this._ptLookup = []), (this._overwrite = h), d || l || Qi(a) || Qi(n))) {
                    if (((t = this.vars), (_ = this.timeline = new G({ data: "nested", defaults: c || {} })), _.kill(), (_.parent = _._dp = this), (_._start = 0), d)) he(_.vars.defaults, { ease: "none" }), d.forEach((P) => _.to(g, P, ">"));
                    else {
                        if (((T = g.length), (w = l ? ys(l) : lt), Te(l))) for (m in l) ~Os.indexOf(m) && (b || (b = {}), (b[m] = l[m]));
                        for (v = 0; v < T; v++) {
                            x = {};
                            ...
                            (x.stagger = 0),
                                ...
                                !l && T === 1 && x.delay && ((this._delay = n = x.delay), (this._start += n), (x.delay = 0)),
                                _.to(y, x, w(v, y, g));
                        }
                ...
                h === !0 && !qt && ((Ae = this), B.killTweensOf(g), (Ae = 0)),
                    u && Dt(u, this),
                    (o || (!a && !d && this._start === S(u._time) && Z(o) && hs(this) && u.data !== "nested")) && ((this._tTime = -D), this.render(Math.max(0, -n))),
                    p && us(this, p);
            }
            render(e, t, i) {
                let r = this._time,
                ...
                if (!n) Vr(this, e, t, i);
                    ...
                    if (((l = o), (g = this.timeline), this._repeat)) {
                        if (((c = n + this._rDelay), this._repeat < -1 && e < 0)) return this.totalTime(c * 100 + e, t, i);
                        if (
                            ((l = S(o % c)),
                            o === a ? ((d = this._repeat), (l = n)) : ((d = ~~(o / c)), d && d === o / c && ((l = n), d--), l > n && (l = n)),
                            (f = this._yoyo && d & 1),
                            ...
                            return this;
                        d !== p && (g && this._yEase && kt(g, f), this.vars.repeatRefresh && !f && !this._lock && ((this._lock = i = 1), (this.render(S(c * d), !0).invalidate()._lock = 0)));
                    }
                    if (!this._initted) {
                    ...
                    (g && g.render(e < 0 ? e : !l && f ? -D : g._dur * u, t, i)) || (this._startAt && (this._zTime = e)),
                        this._onUpdate && !t && (e < 0 && this._startAt && this._startAt.render(e, !0, i), se(this, "onUpdate")),
            ...
            kill(e, t = "all") {
                if (!e && (!t || t === "all")) return (this._lazy = this._pt = 0), this.parent ? ft(this) : this;
                if (this.timeline) {
                    let u = this.timeline.totalDuration();
                    return this.timeline.killTweensOf(e, t, Ae && Ae.vars.overwrite !== !0)._first || ft(this), this.parent && u !== this.timeline.totalDuration() && Ke(this, (this._dur * this.timeline._tDur) / u, 0, 1), this;
                }
                let i = this._targets,
                    r = e ? xe(e) : i,
                    a = this._ptLookup,
                ...
                for (o = this._op = this._op || [], t !== "all" && (j(t) && ((c = {}), J(t, (u) => (c[u] = 1)), (t = c)), (t = sa(i, t))), f = i.length; f--; )
                    if (~r.indexOf(i[f])) {
                        (l = a[f]), t === "all" ? ((o[f] = t), (d = l), (h = {})) : ((h = o[f] = o[f] || {}), (d = t));
                        for (c in d) (p = l && l[c]), p && ((!("kill" in p.d) || p.d.kill(c) === !0) && Mt(this, p, "_pt"), delete l[c]), h !== "all" && (h[c] = 1);
                    }
            ...
            static delayedCall(e, t, i, r) {
                return new L(t, 0, { immediateRender: !1, lazy: !1, overwrite: !1, delay: e, onComplete: t, onReverseComplete: t, onCompleteParams: i, onReverseCompleteParams: i, callbackScope: r });
            }
            static fromTo(e, t, i) {
    ...
    var mi = (s, e, t) => (s[e] = t),
        ...
        _i = function (s, e) {
            ...
            if (!s && e.b) i = e.b;
                ...
                for (; t; ) (i = t.p + (t.m ? t.m(t.s + t.c * s) : Math.round((t.s + t.c * s) * 1e4) / 1e4) + i), (t = t._next);
                i += e.c;
            }
            e.set(e.t, e.p, i, e);
        },
        ...
        Hr = function (s) {
            let e = this._pt,
                t,
                i;
            for (; e; ) (i = e._next), (e.p === s && !e.op) || e.op === s ? Mt(this, e, "_pt") : e.dep || (t = 1), (e = i);
            return !t;
        },
        na = (s, e, t, i) => {
        ...
        yi = (s) => {
            ...
            for (; e; ) {
                ...
                (e._prev = i ? i._prev : a) ? (e._prev._next = e) : (r = e), (e._next = i) ? (i._prev = e) : (a = e), (e = t);
            }
            s._pt = r;
        },
        X = class {
            constructor(e, t, i, r, a, n, o, l, h) {
                (this.t = t), (this.s = r), (this.c = a), (this.p = i), (this.r = n || ks), (this.d = o || this), (this.set = l || mi), (this.pr = h || 0), (this._next = e), e && (e._prev = this);
            }
            modifier(e, t, i) {
                (this.mSet = this.mSet || this.set), (this.set = na), (this.m = e), (this.mt = i), (this.tween = t);
            }
        };
    J(
        ri +
    ...
    B = new G({ sortChildren: !1, defaults: qe, autoRemoveChildren: !0, id: "root", smoothChildTiming: !0 });
    q.stringFilter = gi;
    var Vt = {
        registerPlugin(...s) {
            s.forEach((e) => Xr(e));
        ...
        getProperty(s, e, t, i) {
            ...
            let r = Ee(s || {}).get,
                a = t ? os : ns;
            return t === "native" && (t = ""), s && (e ? a(((K[e] && K[e].get) || r)(s, e, t, i)) : (n, o, l) => a(((K[n] && K[n].get) || r)(s, n, o, l)));
        },
        quickSetter(s, e, t) {
            ...
            let i = K[e],
                ...
                n = i
                    ? (o) => {
                          let l = new i();
                          (et._pt = 0), l.init(s, t ? o + t : o, et, 0, [s]), l.render(1, l), et._pt && fi(1, et);
                      }
                    : r.set(s, a);
        ...
        exportRoot(s = {}, e) {
            let t = new G(s),
                i,
                r;
            for (t.smoothChildTiming = Z(s.smoothChildTiming), B.remove(t), t._dp = 0, t._time = t._tTime = B._time, i = B._first; i; )
                (r = i._next), (e || !(!i._dur && i instanceof L && i.vars.onComplete === i._targets[0])) && Pe(t, i, i._start - i._delay), (i = r);
            return Pe(B, t, 0), t;
        },
        utils: { wrap: Ps, wrapYoyo: Rs, distribute: ys, random: bs, snap: vs, normalize: jr, getUnit: $, clamp: Ur, splitColor: Ms, toArray: xe, mapRange: ws, pipe: Nr, unitize: Wr, interpolate: Ss, shuffle: ms },
        install: es,
        effects: si,
        ticker: ie,
        ...
        plugins: K,
        globalTimeline: B,
        core: { PropTween: X, globals: is, Tween: L, Timeline: G, Animation: it, getCache: Ee, _removeLinkedListItem: Mt, suppressOverwrites: (s) => (qt = s) },
    };
    ...
    var oa = (s, e) => {
        ...
        ha = (s, e) => {
            let t = s._targets,
                ...
                r,
                a;
            for (i in e) for (r = t.length; r--; ) (a = s._ptLookup[r][i]), a && (a = a.d) && (a._pt && (a = oa(a, i)), a && a.modifier && a.modifier(e[i], s, t[r], i));
        },
        vi = (s, e) => ({
            name: s,
            rawVars: 1,
            ...
            Vt.registerPlugin(
                {
                    ...
                    init(s, e, t, i, r) {
                        let a, n;
                        for (a in e) (n = this.add(s, "setAttribute", (s.getAttribute(a) || 0) + "", e[a], i, r, 0, 0, a)), n && (n.op = a), this._props.push(a);
                    },
                },
                {
                    name: "endArray",
    ...
    var Fs,
        ...
        ca = (s, e) => e.set(e.t, e.p, s === 1 ? e.e : Math.round((e.s + e.c * s) * 1e4) / 1e4 + e.u, e),
        ...
        zt = function (s) {
            let e = wi("svg", (this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns")) || "http://www.w3.org/2000/svg"),
                t = this.parentNode,
                i = this.nextSibling,
            ...
            return t && (i ? t.insertBefore(this, i) : t.appendChild(this)), st.removeChild(e), (this.style.cssText = r), a;
        },
        Gs = (s, e) => {
            let t = e.length;
        ...
        Hs = (s) => {
            ...
            return (e && (e.width || e.height)) || s.getBBox === zt || (e = zt.call(s, !0)), e && !e.width && !e.x && !e.y ? { x: +Gs(s, ["x", "cx", "x1"]) || 0, y: +Gs(s, ["y", "cy", "y1"]) || 0, width: 0, height: 0 } : e;
        },
        Xs = (s) => !!(s.getCTM && (!s.parentNode || s.ownerSVGElement) && Hs(s)),
        It = (s, e) => {
            if (e) {
                let t = s.style;
                e in ke && e !== Fe && (e = re), t.removeProperty ? ((e.substr(0, 2) === "ms" || e.substr(0, 6) === "webkit") && (e = "-" + e), t.removeProperty(e.replace(Is, "-$1").toLowerCase())) : t.removeAttribute(e);
            }
        },
        Ve = (s, e, t, i, r, a) => {
            ...
            return i === a || !r || Ys[i] || Ys[a]
                ...
                : (a !== "px" && !c && (r = Re(s, e, t, "px")),
                  ...
                  (p || a === "%") && (ke[e] || ~e.indexOf("adius"))
                      ? ((f = _ ? s.getBBox()[o ? "width" : "height"] : s[h]), S(p ? (r / f) * d : (r / 100) * f))
        ...
        ot = (s, e, t, i) => {
            ...
            return (
                ...
                ke[e] && e !== "transform"
                    ? ((r = Bt(s, i)), (r = e !== "transformOrigin" ? r[e] : Nt(ve(s, Fe)) + " " + r.zOrigin + "px"))
                    : ((r = s.style[e]), (!r || r === "auto" || i || ~(r + "").indexOf("calc(")) && (r = (Ut[e] && Ut[e](s, e, t)) || ve(s, e) || ni(s, e) || (e === "opacity" ? 1 : 0))),
        ...
        ba = function (s, e, t, i) {
            ...
            let r = new X(this._pt, s.style, e, 0, 1, _i),
                ...
                T;
            if (
                ((r.b = t), (r.e = i), (t += ""), (i += ""), i === "auto" && ((s.style[e] = i), (i = ve(s, e) || i), (s.style[e] = t)), (o = [t, i]), gi(o), (t = o[0]), (i = o[1]), (h = t.match(Be) || []), (T = i.match(Be) || []), T.length)
            ) {
                for (; (l = Be.exec(i)); )
                    (f = l[0]),
                        ...
                        f !== (p = h[n++] || "") &&
                            ...
                            v !== _ && (d = Re(s, e, p, _) || 0),
                            (r._pt = { _next: r._pt, p: g || n === 1 ? g : ",", s: d, c: x ? x * u : u - d, m: (c && c < 4) || e === "zIndex" ? Math.round : 0 }));
        ...
        wa = (s) => {
            let e = s.split(" "),
                t = e[0],
                i = e[1] || "50%";
            return (t === "top" || t === "bottom" || i === "left" || i === "right") && ((s = t), (t = i), (i = s)), (e[0] = qs[t] || t), (e[1] = qs[i] || i), e.join(" ");
        },
        Ta = (s, e) => {
            if (e.tween && e.tween._time === e.tween._dur) {
                ...
                else for (r = r.split(","), l = r.length; --l > -1; ) (n = r[l]), ke[n] && ((o = 1), (n = n === "transformOrigin" ? Fe : re)), It(t, n);
        ...
        Pi = (s, e) => {
            ...
            return t.svg && s.getAttribute("transform")
                ? ((o = s.transform.baseVal.consolidate().matrix), (r = [o.a, o.b, o.c, o.d, o.e, o.f]), r.join(",") === "1,0,0,1,0,0" ? mt : r)
                : (r === mt &&
                      !s.offsetParent &&
                      s !== st &&
                      !t.svg &&
        ...
        Ri = (s, e, t, i, r, a) => {
            let n = s._gsap,
                ...
                P;
            t
                ? o !== mt && (w = p * g - f * u) && ((b = T * (g / w) + m * (-u / w) + (u * v - g * _) / w), (P = T * (-f / w) + m * (p / w) - (p * v - f * _) / w), (T = b), (m = P))
                : ((y = Hs(s)), (T = y.x + (~x[0].indexOf("%") ? (T / 100) * y.width : T)), (m = y.y + (~(x[1] || x[0]).indexOf("%") ? (m / 100) * y.height : m))),
                i || (i !== !1 && n.smooth) ? ((_ = T - l), (v = m - h), (n.xOffset = d + (_ * p + v * u) - _), (n.yOffset = c + (_ * f + v * g) - v)) : (n.xOffset = n.yOffset = 0),
                (n.xOrigin = T),
                (n.yOrigin = m),
                (n.smooth = !!i),
                (n.origin = e),
                ...
                (s.style[Fe] = "0px 0px"),
                a && (Ve(a, n, "xOrigin", l, T), Ve(a, n, "yOrigin", h, m), Ve(a, n, "xOffset", d, n.xOffset), Ve(a, n, "yOffset", c, n.yOffset)),
        ...
        Bt = (s, e) => {
            ...
            return (
                ...
                (t.svg = !!(s.getCTM && Xs(s))),
                (y = Pi(s, t.svg)),
                t.svg && ((V = !t.uncache && s.getAttribute("data-svg-origin")), Ri(s, V || o, !!V || t.originIsAbsolute, t.smooth !== !1, y)),
                (T = t.xOrigin || 0),
                (m = t.yOrigin || 0),
                y !== mt &&
                    ((C = y[0]),
                    ...
                    y.length === 6
                        ...
                        : ((Ue = y[6]),
                          ...
                          (w = at(-F, ge)),
                          (g = w * Ge),
                          w && ((b = Math.cos(-w)), (P = Math.sin(-w)), (V = C * b - pe * P), (M = E * b - Ce * P), (fe = F * b - ge * P), (we = I * P + we * b), (C = V), (E = M), (F = fe)),
                          (w = at(E, C)),
                          (f = w * Ge),
                          w && ((b = Math.cos(w)), (P = Math.sin(w)), (V = C * b + E * P), (M = k * b + U * P), (E = E * b - C * P), (U = U * b - k * P), (C = V), (k = M)),
                          ...
                          (x = we ? 1 / (we < 0 ? -we : we) : 0)),
                    t.svg && ((V = s.getAttribute("transform")), (t.forceCSS = s.setAttribute("transform", "") || !Zs(ve(s, re))), V && s.setAttribute("transform", V))),
                Math.abs(_) > 90 && Math.abs(_) < 270 && (r ? ((c *= -1), (_ += f <= 0 ? 180 : -180), (f += f <= 0 ? 180 : -180)) : ((p *= -1), (_ += _ <= 0 ? 180 : -180))),
        ...
        Js = function (s, e) {
            ...
            if (v && (h !== He || l !== He)) {
                let m = parseFloat(l) * rt,
                    ...
                    w = Math.cos(m),
                    b;
                (m = parseFloat(h) * rt), (b = Math.cos(m)), (r = Si(_, r, y * b * -v)), (a = Si(_, a, -Math.sin(m) * -v)), (n = Si(_, n, w * b * -v + v));
            }
        ...
        Ra = function (s, e) {
            let { xPercent: t, yPercent: i, x: r, y: a, rotation: n, skewX: o, skewY: l, scaleX: h, scaleY: d, target: c, xOrigin: p, yOrigin: f, xOffset: u, yOffset: g, forceCSS: _ } = e || this,
                v = parseFloat(r),
                x = parseFloat(a),
                T,
                m,
            ...
            (n = parseFloat(n)),
                ...
                n || o
                    ? ((n *= rt),
                      ...
                      (y = Math.sin(n - o) * -d),
                      (w = Math.cos(n - o) * d),
                      o && ((l *= rt), (b = Math.tan(o - l)), (b = Math.sqrt(1 + b * b)), (y *= b), (w *= b), l && ((b = Math.tan(l)), (b = Math.sqrt(1 + b * b)), (T *= b), (m *= b))),
                      (T = S(T)),
                      (m = S(m)),
                      (y = S(y)),
                      (w = S(w)))
                    : ((T = h), (w = d), (m = y = 0)),
                ((v && !~(r + "").indexOf("px")) || (x && !~(a + "").indexOf("px"))) && ((v = Re(c, "x", r, "px")), (x = Re(c, "y", a, "px"))),
                (p || f || u || g) && ((v = S(v + p - (p * T + f * y) + u)), (x = S(x + f - (p * m + f * w) + g))),
                (t || i) && ((b = c.getBBox()), (v = S(v + (t / 100) * b.width)), (x = S(x + (i / 100) * b.height))),
        ...
        Ca = (s, e, t) => {
            let i = _t.style,
                ...
                p,
                f;
            (i.cssText = getComputedStyle(t).cssText + ";position:absolute;display:block;"), (i[re] = e), ye.body.appendChild(_t), (n = Bt(_t, 1));
            for (o in ke)
                (l = r[o]),
                    (h = n[o]),
                    l !== h && a.indexOf(o) < 0 && ((p = $(l)), (f = $(h)), (d = p !== f ? Re(t, o, l, f) : parseFloat(l)), (c = parseFloat(h)), (s._pt = new X(s._pt, r, o, d, c - d, Us)), (s._pt.u = f || 0), s._props.push(o));
    ...
    J("padding,margin,Width,Radius", (s, e) => {
        ...
        Ut[e > 1 ? "border" + s : s] = function (o, l, h, d, c) {
            let p, f;
            if (arguments.length < 4) return (p = n.map((u) => ot(o, u, h))), (f = p.join(" ")), f.split(p[0]).length === 5 ? p[0] : f;
            (p = (d + "").split(" ")), (f = {}), n.forEach((u, g) => (f[u] = p[g] = p[g] || p[((g - 1) / 2) | 0])), o.init(l, f, c);
        };
    });
    var Ci = {
        name: "css",
        ...
        init(s, e, t, i, r) {
            ...
            for (u in e)
                if (u !== "autoRound" && ((h = e[u]), !(K[u] && xi(u, e, t, i, s, r)))) {
                    if (((p = typeof h), (f = Ut[u]), p === "function" && ((h = h.call(t, i, s, r)), (p = typeof h)), p === "string" && ~h.indexOf("random(") && (h = ct(h)), f)) f(this, s, u, h, t) && (w = 1);
                    else if (u.substr(0, 2) === "--")
                        (l = (getComputedStyle(s).getPropertyValue(u) + "").trim()), (h += ""), (g = $(l)), (_ = $(h)), _ ? g !== _ && (l = Re(s, u, l, _) + _) : g && (h += g), this.add(n, "setProperty", l, h, i, r, 0, 0, u);
                    else if (p !== "undefined") {
                        if (
                            (o && u in o ? ((l = typeof o[u] == "function" ? o[u].call(t, i, s, r) : o[u]), u in q.units && !$(l) && (l += q.units[u]), (l + "").charAt(1) === "=" && (l = ot(s, u))) : (l = ot(s, u)),
                            (c = parseFloat(l)),
                            (v = p === "string" && h.charAt(1) === "=" ? +(h.charAt(0) + "1") : 0),
                            v && (h = h.substr(2)),
                            (d = parseFloat(h)),
                            u in Oe &&
                                (u === "autoAlpha" && (c === 1 && ot(s, "visibility") === "hidden" && d && (c = 0), Ve(this, n, "visibility", c ? "inherit" : "hidden", d ? "inherit" : "hidden", !d)),
                                u !== "scale" && u !== "transform" && ((u = Oe[u]), ~u.indexOf(",") && (u = u.split(",")[0]))),
                            (x = u in ke),
                            x)
                        ) {
                            if (
                                ...
                                (this._pt = new X(this._pt, m, "scaleY", m.scaleY, v ? v * d : d - m.scaleY)), a.push("scaleY", u), (u += "X");
                            else if (u === "transformOrigin") {
                                (h = wa(h)), m.svg ? Ri(s, h, 0, y, 0, this) : ((_ = parseFloat(h.split(" ")[2]) || 0), _ !== m.zOrigin && Ve(this, m, "zOrigin", m.zOrigin, _), Ve(this, n, u, Nt(l), Nt(h)));
                                continue;
                            } else if (u === "svgOrigin") {
                                Ri(s, h, 1, y, 0, this);
                                continue;
            ...
            constructor({ root: e, rootMargin: t = "0px", threshold: i = 0 }) {
                window.IntersectionObserver
                    ? ((this.root = document.querySelector(e)),
                      ...
                      (this.els = []),
                      (this._staggerEls = []),
                      (this.observer = new IntersectionObserver(this._callback.bind(this), { root: this.root === "viewport" ? null : this.root, rootMargin: this.rootMargin, threshold: this.threshold })))
                    : setTimeout(() => {
                        ...
                        if (t.intersectionRatio > i.triggerRatio) {
                            if (i.alwaysTrigger || !i.inView) {
                                ...
                                this._staggerEls.forEach((a) => {
                                    ...
                                    setTimeout(() => {
                                        i.onElVisible && i.onElVisible(i), (this._staggerEls = this._staggerEls.filter((a) => i.id !== a.id));
                                    }, r);
                            }
                            i.inView = !0;
                        } else i.inView && t.intersectionRatio <= i.triggerRatio && ((i.inView = !1), i.onElHidden && i.onElHidden(i), i.keepObserving || this._unobserve(i));
                        (i.ratio = t.intersectionRatio), (i.boundingClientRect = t.boundingClientRect);
                    }
                });
            }
            observe({ elements: e = [], selector: t, keepObserving: i = !1, triggerRatio: r = 0, alwaysTrigger: a = !0, stagger: n = 0, onBeforeElVisible: o = () => {}, onElVisible: l = () => {}, onElHidden: h = () => {} }) {
    ...
    var Ei = class {
        constructor({
            ...
            (this.container = e),
                (this.isiOS = n),
                (this.params = { cancelNavigationClass: t, cacheLinks: i, cacheNavigatedPages: r, cacheLength: a, onStart: o, onReady: l, onLeaving: h, onWaiting: d, onError: c }),
        ...
        _initEvents() {
            if (
                ...
                window.addEventListener("popstate", () => {
                    let e, t;
                    (e = this.router.history[this.router.history.length - 1].href), (t = window.location.href);
                    let i,
                        r,
                        a = !1;
                    if (e.indexOf("#") !== -1) {
                ...
                window.addEventListener(
                    ...
                    (a) => {
                        (e = performance.now()),
                            (t = a.target),
                            a.targetTouches
                                ? ((i = { x: a.targetTouches[0].clientX, y: a.targetTouches[0].clientY }), (r = { x: a.targetTouches[0].clientX, y: a.targetTouches[0].clientY }))
                    ...
                    window.addEventListener(
                        "touchmove",
                        (a) => {
                            a.targetTouches ? (r = { x: a.targetTouches[0].clientX, y: a.targetTouches[0].clientY }) : (r = { x: a.clientX, y: a.clientY });
                        },
                        { passive: !0 }
                    ),
        ...
        _handleClick(e) {
            ...
            if (!(this.params.cancelNavigationClass && t.classList.contains(this.params.cancelNavigationClass)) && i.indexOf("mailto:") === -1 && !t.getAttribute("download") && !(e.ctrlKey || e.metaKey || e.shiftKey || e.altKey)) {
                ...
                (this.lastLinkClicked = t), e.preventDefault(), e.stopPropagation(), this._launchNavigation(i, !0);
            }
        }
        _cacheResponse(e, t) {
            let i = { href: e, HTMLContent: this._parseResponseContent(t), title: t.match(/<title[^>]*>([^<]+)<\/title>/)[1] };
        ...
        loadPage(e, t) {
            ...
            r && t
                ? t({ url: e, content: r.HTMLContent, title: r.title, duration: (performance || Date).now() - i })
                : this._AJAXCall(e, !1, (a, n) => {
                      this.params.cacheNavigatedPages && this._cacheResponse(n, a), t && t({ url: n, content: this._parseResponseContent(a), title: a.match(/<title[^>]*>([^<]+)<\/title>/)[1], duration: (performance || Date).now() - i });
                  });
        }
        updateHistory(e, t, i = !0) {
            let r = e || this.router.nextTitle,
                a = t || this.router.nextHref;
            i && window.history.pushState({}, r, a), (document.title = r), this.router.history.push({ href: a, title: r });
        }
        _launchNavigation(e, t) {
            if (!this._isLoading) {
                (this.router.nextHTMLContent = null), this.params.onStart.value(this.router.history[this.router.history.length - 1].href, e);
                let i = this._transitionsManager.isOverriding ? this._transitionsManager.overrideDuration : this.params.onLeaving.duration,
                    r = this.cache.find((a) => a.href === e);
                r ? ((this.router.nextHref = r.href), (this.router.nextHTMLContent = r.HTMLContent), (this.router.nextTitle = r.title)) : this._routing(e, t),
                    setTimeout(() => {
                        this.params.onLeaving.value(this.router.history[this.router.history.length - 1].href, e), this.router.nextHTMLContent ? this._appendData(t) : this._waitForData(t);
                    }, i);
            }
        }
        _parseResponseContent(e) {
            ...
            else if (this.container.classList.length) for (let a = 0; a < this.container.classList.length; a++) i += "." + this.container.classList[a];
        ...
        _AJAXCall(e, t, i) {
            ...
            (r.onreadystatechange = () => {
                r.readyState === 4 && (r.status === 200 || r.status === 0)
                    ...
                    ? (this._ajaxCalls === 0 && !this._transitionsManager.isWaiting && ((this._transitionsManager.isWaiting = !0), this.params.onWaiting.value(this.router.history[this.router.history.length - 1].href, this.router.nextHref)),
                      this._ajaxCalls++,
                      this._routing(r.responseURL, t, i))
                    : r.readyState === 4 && (this._resetRoutingState(), this.params.onError.value(this.router.history[this.router.history.length - 1].href, this.router.nextHref));
            }),
                r.open("GET", e, !0),
        ...
        _waitForData(e) {
            this._transitionsManager.isWaiting || ((this._transitionsManager.isWaiting = !0), this.params.onWaiting.value(this.router.history[this.router.history.length - 1].href, this.router.nextHref));
            let t = setInterval(() => {
        ...
        _newContentAdded() {
            setTimeout(() => {
                this.params.onReady.value(this.router.history[this.router.history.length - 2].href, this.router.history[this.router.history.length - 1].href), this._resetRoutingState(), this.params.cacheLinks && this._cacheContainerLinks();
            }, 0);
        }
        _appendData(e) {
        ...
        _resetRoutingState() {
            (this._ajaxCalls = 0), (this._isLoading = !1), (this._transitionsManager.isWaiting = !1), (this._transitionsManager.isOverriding = !1);
        }
    ...
    var Li = class {
        ...
        addToRenderTargetsStack(e) {
            ...
            (i = Math.max(0, i)),
                t.splice(i, 0, e),
                e.target._depth ? (t.sort((r, a) => r.index - a.index), t.sort((r, a) => a.renderOrder - r.renderOrder)) : (t.sort((r, a) => a.index - r.index), t.sort((r, a) => r.renderOrder - a.renderOrder)),
        ...
        addPlane(e) {
            if (e.type === "PingPongPlane") this.stacks.pingPong.push(e);
                ...
                t.sort((i, r) => r.relativeTranslation.z - i.relativeTranslation.z), t.sort((i, r) => r.renderOrder - i.renderOrder), (this.stacks.transparent = t);
            } else {
                let t = this.addToRegularPlaneStack(e);
        ...
        setPlaneRenderOrder(e) {
            ...
            if (e.target)
                e.target._depth
                    ? (this.stacks.renderTargets.sort((t, i) => t.index - i.index), this.stacks.renderTargets.sort((t, i) => i.renderOrder - t.renderOrder))
                    : (this.stacks.renderTargets.sort((t, i) => i.index - t.index), this.stacks.renderTargets.sort((t, i) => t.renderOrder - i.renderOrder)),
                ...
                !this.renderer.depth || i
                    ? (t.sort((r, a) => a.index - r.index), e._transparent && t.sort((r, a) => r.relativeTranslation.z - a.relativeTranslation.z), t.sort((r, a) => r.renderOrder - a.renderOrder))
                    : (t.sort((r, a) => r.index - a.index), e._transparent && t.sort((r, a) => a.relativeTranslation.z - r.relativeTranslation.z), t.sort((r, a) => a.renderOrder - r.renderOrder));
            }
        }
        addShaderPass(e) {
    ...
    var Oi = class {
        constructor({
            ...
            if (((this.gl = this.canvas.getContext("webgl2", x)), (this._isWebGL2 = !!this.gl), this.gl || (this.gl = this.canvas.getContext("webgl", x) || this.canvas.getContext("experimental-webgl", x)), this.gl))
                this.onSuccess && this.onSuccess();
            else {
                this.production || R(this.type + ": WebGL context could not be created"), (this.state.isActive = !1), this.onError && this.onError();
                return;
            }
            this.initRenderer();
        }
            ...
            !this.state.isActive ||
                ...
                this.gl && this.extensions.WEBGL_lose_context
                    ...
                    : (!this.gl && !this.production
                          ...
                          : !this.extensions.WEBGL_lose_context && !this.production && R(this.type + ": Could not restore the context because the restore context extension is not defined"),
        ...
        contextRestored() {
            this.getExtensions(), this.setBlendFunc(), this.setDepthTest(!0), this.cache.clear(), this.scene.initStacks();
        ...
        setSize() {
            ...
            this._boundingRect = { width: e.width * this.pixelRatio, height: e.height * this.pixelRatio, top: e.top * this.pixelRatio, left: e.left * this.pixelRatio };
        ...
        bindFrameBuffer(e, t) {
            let i = null;
            e
                ? ((i = e.index), i !== this.state.frameBufferID && (this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, e._frameBuffer), this.gl.viewport(0, 0, e._size.width, e._size.height), e._shouldClear && !t && this.clear()))
                : this.state.frameBufferID !== null && (this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, null), this.gl.viewport(0, 0, this.gl.drawingBufferWidth, this.gl.drawingBufferHeight)),
        ...
        removeRenderTarget(e) {
            ...
            for (let i = 0; i < this.planes.length; i++) this.planes[i].target && this.planes[i].target.uuid === e.uuid && (this.planes[i].target = null);
    ...
    var Fi = class {
        ...
        updateScrollValues(e, t) {
            ...
            let r = this.yOffset;
            (this.yOffset = t), (this.lastYDelta = r - this.yOffset), this.onScroll && this.onScroll(this.lastXDelta, this.lastYDelta);
        }
        dispose() {
    ...
    var Wt = class {
        ...
        setContainer(e) {
            if (e)
                ...
                let t = document.createElement("div");
                t.setAttribute("id", "curtains-canvas"), document.body.appendChild(t), (this.container = t), this.production || R('Curtains: no valid container HTML element or ID provided, created a div with "curtains-canvas" ID instead');
            }
            this._initCurtains();
        }
        _initCurtains() {
            (this.planes = []),
                ...
                (this.shaderPasses = []),
                this._initRenderer(),
                !!this.gl && (this._initScroll(), this._setSize(), this._addListeners(), this.container.appendChild(this.canvas), (this._animationFrameID = null), this._autoRender && this._animate());
        }
        _initRenderer() {
        ...
        render() {
            this.renderer.nextRender.execute(),
                !(!this.renderer.state.drawingEnabled && !this.renderer.state.forceRender) &&
                    (this.renderer.state.forceRender && (this.renderer.state.forceRender = !1), this._onRenderCallback && this._onRenderCallback(), this.renderer.render());
        }
        _addListeners() {
        ...
        _initScroll() {
            this._scrollManager = new Fi({ xOffset: window.pageXOffset, yOffset: window.pageYOffset, lastXDelta: 0, lastYDelta: 0, shouldWatch: this._watchScroll, onScroll: (e, t) => this._updateScroll(e, t) });
        }
        _updateScroll(e, t) {
            for (let i = 0; i < this.planes.length; i++) this.planes[i].watchScroll && this.planes[i].updateScrollPosition(e, t);
    ...
    var Vi = class {
        constructor(e, t, i) {
            if (
                ...
                for (let r in i) {
                    let a = i[r];
                    this.uniforms[r] = { name: a.name, type: a.type, value: a.value.clone && typeof a.value.clone == "function" ? a.value.clone() : a.value, update: null };
                }
        }
                    ...
                    (t.location = this.gl.getUniformLocation(this.program, t.name)),
                        ...
                        t.type ||
                            (t._internalFormat === "Vec2"
                                ...
                                ? t.value.length === 4
                                    ? ((t.type = "4f"), this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a 4f (array of 4 floats) uniform type"))
                                    : t.value.length === 3
                                    ? ((t.type = "3f"), this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a 3f (array of 3 floats) uniform type"))
                                    : t.value.length === 2 && ((t.type = "2f"), this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a 2f (array of 2 floats) uniform type"))
                                : t._internalFormat === "mat"
                                ? t.value.length === 16
                                    ? ((t.type = "mat4"), this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a mat4 (4x4 matrix array) uniform type"))
                                    : t.value.length === 9
                                    ? ((t.type = "mat3"), this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a mat3 (3x3 matrix array) uniform type"))
                                    : t.value.length === 4 && ((t.type = "mat2"), this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a mat2 (2x2 matrix array) uniform type"))
                                : ((t.type = "1f"), this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a 1f (float) uniform type"))),
            ...
            if (this.uniforms)
                for (let e in this.uniforms) {
                    ...
                    t._internalFormat === "Vec2" || t._internalFormat === "Vec3" || t._internalFormat === "Quat"
                        ...
                        : t.value.length
                        ? JSON.stringify(t.value) !== JSON.stringify(t.lastValue) && ((i = !0), (t.lastValue = Array.from(t.value)))
        ...
        Gt = class {
            constructor(e, { parent: t, vertexShader: i, fragmentShader: r } = {}) {
                (this.type = "Program"),
                    ...
                    i ? (this.vsCode = i) : (!this.renderer.production && this.parent.type === "Plane" && R(this.parent.type + ": No vertex shader provided, will use a default one"), (this.vsCode = this.defaultVsCode)),
                    r ? (this.fsCode = r) : (this.renderer.production || R(this.parent.type + ": No fragment shader provided, will use a default one"), (this.fsCode = this.defaultFsCode)),
                    (this.compiled = !0),
                    this.setupProgram();
            }
            createShader(e, t) {
                let i = this.gl.createShader(t);
                if ((this.gl.shaderSource(i, e), this.gl.compileShader(i), !this.renderer.production && !this.gl.getShaderParameter(i, this.gl.COMPILE_STATUS))) {
...
`,
            ...
            setupProgram() {
                ...
                e
                    ? ((this.vertexShader = e.vertexShader), (this.fragmentShader = e.fragmentShader), (this.activeUniforms = e.activeUniforms), this.createProgram())
            ...
            createProgram() {
                ...
                if ((this.gl.deleteShader(this.vertexShader), this.gl.deleteShader(this.fragmentShader), !this.activeUniforms)) {
    ...
    var zi = class {
        ...
        setDefaultAttributes() {
            this.attributes = { vertexPosition: { name: "aVertexPosition", size: 3 }, textureCoord: { name: "aTextureCoord", size: 3 } };
        }
        setVerticesUVs() {
            ...
            e
                ...
                : (this.computeVerticesUVs(), this.renderer.cache.addGeometry(this.definition.id, this.attributes.vertexPosition.array, this.attributes.textureCoord.array));
        }
        setProgram(e) {
            (this.program = e.program),
                ...
                this.renderer._isWebGL2
                    ...
                    : this.renderer.extensions.OES_vertex_array_object &&
                      ((this._vao = this.renderer.extensions.OES_vertex_array_object.createVertexArrayOES()), this.renderer.extensions.OES_vertex_array_object.bindVertexArrayOES(this._vao)),
        ...
        dispose() {
            ...
            for (let e in this.attributes) this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.attributes[e].buffer), this.gl.bufferData(this.gl.ARRAY_BUFFER, 1, this.gl.STATIC_DRAW), this.gl.deleteBuffer(this.attributes[e].buffer);
    ...
    var A = class {
        ...
        applyMat4(e) {
            ...
            return (n = n || 1), (this._x = (a[0] * t + a[4] * i + a[8] * r + a[12]) / n), (this._y = (a[1] * t + a[5] * i + a[9] * r + a[13]) / n), (this._z = (a[2] * t + a[6] * i + a[10] * r + a[14]) / n), this;
        }
        applyQuat(e) {
            let t = this._x,
                i = this._y,
                ...
                c = l * r + a * i - n * t,
                p = -a * t - n * i - o * r;
            return (this._x = h * l + p * -a + d * -o - c * -n), (this._y = d * l + p * -n + c * -a - h * -o), (this._z = c * l + p * -o + h * -n - d * -a), this;
        }
        project(e) {
    ...
    var Ii = new N(),
        ...
        ae = class {
            constructor(
                e,
                { isFBOTexture: t = !1, fromTexture: i = !1, loader: r, sampler: a, floatingPoint: n = "none", premultiplyAlpha: o = !1, anisotropy: l = 1, generateMipmap: h = null, wrapS: d, wrapT: c, minFilter: p, magFilter: f } = {}
            ) {
                if (
                    ((this.type = "Texture"),
                    (e = (e && e.renderer) || e),
                    ...
                    (this.gl = this.renderer.gl),
                    (this.uuid = ht()),
                    (this._globalParameters = { unpackAlignment: 4, flipY: !t, premultiplyAlpha: !1, shouldPremultiplyAlpha: o, floatingPoint: n, type: this.gl.UNSIGNED_BYTE, internalFormat: this.gl.RGBA, format: this.gl.RGBA }),
                    (this.parameters = { anisotropy: l, generateMipmap: h, wrapS: d || this.gl.CLAMP_TO_EDGE, wrapT: c || this.gl.CLAMP_TO_EDGE, minFilter: p || this.gl.LINEAR, magFilter: f || this.gl.LINEAR, _shouldUpdate: !0 }),
                    this._initState(),
            ...
            _initState() {
                this._state = { anisotropy: 1, generateMipmap: !1, wrapS: null, wrapT: null, minFilter: null, magFilter: this.gl.LINEAR };
            }
            _initTexture() {
            ...
            _setParent() {
                if (((this._sampler.name = this._samplerName || "uSampler" + this.index), (this._textureMatrix.name = this._samplerName ? this._samplerName + "Matrix" : "uTextureMatrix" + this.index), this._parent._program)) {
                    ...
                    this.source
                        ...
                        : (this._size = { width: this._parent._boundingRect.document.width, height: this._parent._boundingRect.document.height }),
                        this._setSize();
                } else
                ...
                for (let t = 0; t < e.textures.length; t++)
                    e.textures[t] === this._sampler.name &&
                        ...
                        e.textureMatrices.find((r) => r === this._textureMatrix.name) &&
                            ((this._textureMatrix.isActive = !0), (this._textureMatrix.location = this.gl.getUniformLocation(this._parent._program.program, this._textureMatrix.name))),
            ...
            copy(e) {
                ...
                (this._globalParameters = e._globalParameters),
                    ...
                    (this._copiedFrom = e),
                    this._parent && this._parent._program && (!this._canDraw || !this._textureMatrix.matrix) && (this._setSize(), (this._canDraw = !0)),
                    this.renderer.needRender();
            }
            setSource(e) {
                ...
                if (t && t.uuid !== this.uuid) {
                    this._uploaded || (this.renderer.nextRender.add(() => this._onSourceUploadedCallback && this._onSourceUploadedCallback()), (this._uploaded = !0)), this.copy(t), this.resize();
                    return;
                }
                (this.source = e),
                    this.sourceType === "empty" &&
                    ...
                    (this._size = { width: this.source.naturalWidth || this.source.width || this.source.videoWidth, height: this.source.naturalHeight || this.source.height || this.source.videoHeight }),
            ...
            _updateGlobalTexParameters() {
                this.renderer.state.unpackAlignment !== this._globalParameters.unpackAlignment &&
                    (this.gl.pixelStorei(this.gl.UNPACK_ALIGNMENT, this._globalParameters.unpackAlignment), (this.renderer.state.unpackAlignment = this._globalParameters.unpackAlignment)),
                    this.renderer.state.flipY !== this._globalParameters.flipY && (this.gl.pixelStorei(this.gl.UNPACK_FLIP_Y_WEBGL, this._globalParameters.flipY), (this.renderer.state.flipY = this._globalParameters.flipY)),
                    this.renderer.state.premultiplyAlpha !== this._globalParameters.premultiplyAlpha &&
                        (this.gl.pixelStorei(this.gl.UNPACK_PREMULTIPLY_ALPHA_WEBGL, this._globalParameters.premultiplyAlpha), (this.renderer.state.premultiplyAlpha = this._globalParameters.premultiplyAlpha)),
            ...
            _updateTexParameters() {
                this.index && this.renderer.state.activeTexture !== this.index && this._bindTexture(this),
                    this.parameters.wrapS !== this._state.wrapS &&
                        (!this.renderer._isWebGL2 && (!ce(this._size.width) || !ce(this._size.height)) && (this.parameters.wrapS = this.gl.CLAMP_TO_EDGE),
...
gl.CLAMP_TO_EDGE wrapping will be used instead`
                    ...
                    this.parameters.wrapT !== this._state.wrapT &&
                        (!this.renderer._isWebGL2 && (!ce(this._size.width) || !ce(this._size.height)) && (this.parameters.wrapT = this.gl.CLAMP_TO_EDGE),
...
gl.CLAMP_TO_EDGE wrapping will be used instead`
                    ...
                    this.parameters.generateMipmap &&
                        ...
                        this.source &&
                        (!this.renderer._isWebGL2 && (!ce(this._size.width) || !ce(this._size.height)) ? (this.parameters.generateMipmap = !1) : this.gl.generateMipmap(this.gl.TEXTURE_2D),
                        (this._state.generateMipmap = this.parameters.generateMipmap)),
                    this.parameters.minFilter !== this._state.minFilter &&
                        (!this.renderer._isWebGL2 && (!ce(this._size.width) || !ce(this._size.height)) && (this.parameters.minFilter = this.gl.LINEAR),
...
gl.LINEAR filtering will be used instead`
                    ...
                    this.parameters.magFilter !== this._state.magFilter &&
                        (!this.renderer._isWebGL2 && (!ce(this._size.width) || !ce(this._size.height)) && (this.parameters.magFilter = this.gl.LINEAR),
...
gl.LINEAR filtering will be used instead`
            ...
            _upload() {
                this._updateGlobalTexParameters(),
                    ...
                    this._uploaded || (this.renderer.nextRender.add(() => this._onSourceUploadedCallback && this._onSourceUploadedCallback()), (this._uploaded = !0));
            }
            _getSizes() {
                ...
                let e = this._parent.scale ? Ii.set(this._parent.scale.x, this._parent.scale.y) : Ii.set(1, 1),
                    ...
                    l = 0,
                    h = 0;
                return o > n ? (h = Math.min(0, i - t * (1 / n))) : o < n && (l = Math.min(0, t - i * n)), { parentWidth: t, parentHeight: i, sourceWidth: r, sourceHeight: a, xOffset: l, yOffset: h };
            }
            setScale(e) {
                ...
                e.sanitizeNaNValuesWith(this.scale).max(Ii.set(0.001, 0.001)), e.equals(this.scale) || (this.scale.copy(e), this.resize());
            }
            setOffset(e) {
                if (!e.type || e.type !== "Vec2") {
            ...
            resize() {
                this.sourceType === "fbo"
                    ...
                    : this.source && (this._size = { width: this.source.naturalWidth || this.source.width || this.source.videoWidth, height: this.source.naturalHeight || this.source.height || this.source.videoHeight }),
                    this._setSize();
            }
            ...
            _bindTexture() {
                this._canDraw &&
                    (this.renderer.state.activeTexture !== this.index && (this.gl.activeTexture(this.gl.TEXTURE0 + this.index), (this.renderer.state.activeTexture = this.index)),
                    this.gl.bindTexture(this.gl.TEXTURE_2D, this._sampler.texture),
                    this._sampler.isTextureBound || ((this._sampler.isTextureBound = !!this.gl.getParameter(this.gl.TEXTURE_BINDING_2D)), this._sampler.isTextureBound && this.renderer.needRender()));
            }
            _draw() {
            ...
            _dispose(e = !1) {
                this.sourceType === "video" || (this.sourceType === "image" && !this.renderer.state.isActive)
                    ...
                    this.gl &&
                        ...
                        ((this._canDraw = !1), this.renderer.cache.removeTexture(this), this.gl.activeTexture(this.gl.TEXTURE0 + this.index), this.gl.bindTexture(this.gl.TEXTURE_2D, null), this.gl.deleteTexture(this._sampler.texture));
            }
        };
    var Ht = class {
        ...
        _addElement(e, t, i, r) {
            let a = { source: e, texture: t, load: this._sourceLoaded.bind(this, e, t, i), error: this._sourceLoadError.bind(this, e, r) };
        ...
        _sourceLoaded(e, t, i) {
            t._sourceLoaded || (t._onSourceLoaded(e), this._parent && (this._increment && this._increment(), this.renderer.nextRender.add(() => this._parent._onLoadingCallback && this._parent._onLoadingCallback(t)))), i && i(t);
        }
        _getSourceType(e) {
            let t;
            return (
        ...
        loadImage(e, t = {}, i, r) {
            let a = this.renderer.cache.getTextureFromSource(e),
                n = Object.assign({}, t);
            if ((this._parent && (n = Object.assign(n, this._parent._texturesOptions)), (n.loader = this), a)) {
                (n.sampler = typeof e != "string" && e.hasAttribute("data-sampler") ? e.getAttribute("data-sampler") : n.sampler), (n.fromTexture = a);
        ...
        loadVideo(e, t = {}, i, r) {
            ...
            (a.preload = !0), (a.muted = !0), (a.loop = !0), a.setAttribute("playsinline", ""), (a.crossOrigin = this.crossOrigin);
            let n = Object.assign({}, t);
            this._parent && (n = Object.assign(t, this._parent._texturesOptions)), (n.loader = this), (n.sampler = a.hasAttribute("data-sampler") ? a.getAttribute("data-sampler") : n.sampler);
            ...
            a.addEventListener("canplaythrough", l.load, !1),
                ...
                "requestVideoFrameCallback" in HTMLVideoElement.prototype && ((l.videoFrameCallback = o._videoFrameCallback.bind(o)), (o._videoFrameCallbackID = a.requestVideoFrameCallback(l.videoFrameCallback)));
        }
        loadVideos(e, t, i, r) {
        ...
        loadCanvas(e, t = {}, i) {
            ...
            this._parent && (r = Object.assign(t, this._parent._texturesOptions)), (r.loader = this), (r.sampler = e.hasAttribute("data-sampler") ? e.getAttribute("data-sampler") : r.sampler);
            let a = new ae(this.renderer, r);
            this._addElement(e, a, i, null), this._sourceLoaded(e, a, i), this._parent && this._addToParent(a, e, "canvas");
        }
        loadCanvases(e, t, i) {
    ...
    var Ui = class extends Ht {
        constructor(e, t, { sourcesLoaded: i = 0, sourcesToLoad: r = 0, complete: a = !1, onComplete: n = () => {} } = {}) {
            ...
            (this.type = "PlaneTextureLoader"),
                (this._parent = t),
                this._parent.type !== "Plane" && this._parent.type !== "PingPongPlane" && this._parent.type !== "ShaderPass" && (R(this.type + ": Wrong parent type assigned to this loader"), (this._parent = null)),
    ...
    var Bi = class {
        constructor(
            ...
            (this.type = t),
                (e = (e && e.renderer) || e),
                (!e || e.type !== "Renderer") &&
                    (z(this.type + ": Curtains not passed as first argument or Curtains Renderer is missing", e),
                    setTimeout(() => {
                        this._onErrorCallback && this._onErrorCallback();
                    }, 0)),
                (this.renderer = e),
                (this.gl = this.renderer.gl),
                this.gl ||
                    (this.renderer.production || z(this.type + ": Unable to create a " + this.type + " because the Renderer WebGl context is not defined"),
                    setTimeout(() => {
                        this._onErrorCallback && this._onErrorCallback();
                    }, 0)),
                (this._canDraw = !1),
                ...
                (this.textures = []),
                (f = Object.assign({ premultiplyAlpha: !1, anisotropy: 1, floatingPoint: "none", wrapS: this.gl.CLAMP_TO_EDGE, wrapT: this.gl.CLAMP_TO_EDGE, minFilter: this.gl.LINEAR, magFilter: this.gl.LINEAR }, f)),
                ...
                (this._program = new Gt(this.renderer, { parent: this, vertexShader: a, fragmentShader: n })),
                this._program.compiled
                    ? (this._program.createUniforms(o), (this.uniforms = this._program.uniformsManager.uniforms), this._geometry.setProgram(this._program), this.renderer.onSceneChange())
        ...
        _restoreContext() {
            (this._canDraw = !1),
                ...
                (this._program = new Gt(this.renderer, { parent: this, vertexShader: this._program.vsCode, fragmentShader: this._program.fsCode })),
        ...
        loadSource(e, t = {}, i, r) {
            this.loader.loadSource(
                ...
                (a, n) => {
                    this.renderer.production || R(this.type + ": this HTML tag could not be converted into a texture:", a.tagName), r && r(a, n);
                }
            );
        }
        loadImage(e, t = {}, i, r) {
...
`,
        ...
        _draw() {
            ...
            for (let e = 0; e < this.textures.length; e++) if ((this.textures[e]._draw(), !this.textures[e]._sampler.isTextureBound)) return;
        ...
        remove() {
            (this._canDraw = !1),
                ...
                this._dispose(),
                this.type === "Plane" ? this.renderer.removePlane(this) : this.type === "ShaderPass" && (this.target && ((this.target._shaderPass = null), this.target.remove(), (this.target = null)), this.renderer.removeShaderPass(this));
        }
        _dispose() {
            if (this.gl) {
    ...
    var nr = new N(),
        ...
        yt = class extends Bi {
            constructor(
                ...
                t,
                i = "DOMMesh",
                { widthSegments: r, heightSegments: a, renderOrder: n, depthTest: o, cullFace: l, uniforms: h, vertexShaderID: d, fragmentShaderID: c, vertexShader: p, fragmentShader: f, texturesOptions: u, crossOrigin: g } = {}
            ) {
            ...
            _setDocumentSizes() {
                ...
                this._boundingRect || (this._boundingRect = {}),
                    (this._boundingRect.document = { width: e.width * this.renderer.pixelRatio, height: e.height * this.renderer.pixelRatio, top: e.top * this.renderer.pixelRatio, left: e.left * this.renderer.pixelRatio });
            }
            getBoundingRect() {
                return {
    ...
    var Ni = class {
        constructor({ fov: e = 50, near: t = 0.1, far: i = 150, width: r, height: a, pixelRatio: n = 1 } = {}) {
            (this.position = new A()), (this.projectionMatrix = new Q()), (this.worldMatrix = new Q()), (this.viewMatrix = new Q()), (this._shouldUpdate = !1), this.setSize(), this.setPerspective(e, t, i, r, a, n);
        }
        setFov(e) {
        ...
        setPerspective(e, t, i, r, a, n) {
            this.setPixelRatio(n), this.setSize(r, a), this.setFov(e), this.setNear(t), this.setFar(i), this._shouldUpdate && this.updateProjectionMatrix();
        }
        setPosition() {
    ...
    var Ye = class {
        ...
        setFromVec3(e) {
            ...
            return (
                this.axisOrder === "XYZ"
                    ? ((this.elements[0] = l * n * o + a * h * d), (this.elements[1] = a * h * o - l * n * d), (this.elements[2] = a * n * d + l * h * o), (this.elements[3] = a * n * o - l * h * d))
                    : this.axisOrder === "YXZ"
                    ? ((this.elements[0] = l * n * o + a * h * d), (this.elements[1] = a * h * o - l * n * d), (this.elements[2] = a * n * d - l * h * o), (this.elements[3] = a * n * o + l * h * d))
                    : this.axisOrder === "ZXY"
                    ? ((this.elements[0] = l * n * o - a * h * d), (this.elements[1] = a * h * o + l * n * d), (this.elements[2] = a * n * d + l * h * o), (this.elements[3] = a * n * o - l * h * d))
                    ...
                    : this.axisOrder === "YZX"
                    ? ((this.elements[0] = l * n * o + a * h * d), (this.elements[1] = a * h * o + l * n * d), (this.elements[2] = a * n * d - l * h * o), (this.elements[3] = a * n * o - l * h * d))
                    : this.axisOrder === "XZY" && ((this.elements[0] = l * n * o - a * h * d), (this.elements[1] = a * h * o - l * n * d), (this.elements[2] = a * n * d + l * h * o), (this.elements[3] = a * n * o + l * h * d)),
                this
            );
        }
    };
        ...
        be = class extends yt {
            constructor(
                ...
                (this.index = this.renderer.planes.length),
                    ...
                    (this.camera = new Ni({ fov: y, width: this.renderer._boundingRect.width, height: this.renderer._boundingRect.height, pixelRatio: this.renderer.pixelRatio })),
            ...
            resetPlane(e) {
                this._initTransformValues(),
                    ...
                    e !== null && !!e
                        ...
                        : !e && !this.renderer.production && R(this.type + ": You are trying to reset a plane with a HTML element that does not exist. The old HTML element will be kept instead.");
            }
            removeRenderTarget() {
            ...
            _initMatrices() {
                ...
                this._matrices = {
                    world: { matrix: e },
                    modelView: { name: "uMVMatrix", matrix: e, location: this.gl.getUniformLocation(this._program.program, "uMVMatrix") },
                    projection: { name: "uPMatrix", matrix: e, location: this.gl.getUniformLocation(this._program.program, "uPMatrix") },
            ...
            setPerspective(e, t, i) {
                this.camera.setPerspective(e, t, i, this.renderer._boundingRect.width, this.renderer._boundingRect.height, this.renderer.pixelRatio),
                    ...
                    this.camera._shouldUpdate && (this._setWorldSizes(), this._applyWorldPositions(), (this._translation.z = this.relativeTranslation.z / this.camera.CSSPerspective)),
            ...
            _setMVMatrix() {
                this._updateMVMatrix &&
                    ...
                    this._matrices.world.matrix.scale({ x: this._boundingRect.world.width, y: this._boundingRect.world.height, z: 1 }),
            ...
            _setWorldPosition() {
                let e = { x: this._boundingRect.document.width / 2 + this._boundingRect.document.left, y: this._boundingRect.document.height / 2 + this._boundingRect.document.top },
            ...
            setScale(e) {
                ...
                e.sanitizeNaNValuesWith(this.scale).max(Ia.set(0.001, 0.001)), (e.x !== this.scale.x || e.y !== this.scale.y) && (this.scale.set(e.x, e.y, 1), this._applyScale());
            }
            _applyScale() {
                for (let e = 0; e < this.textures.length; e++) this.textures[e].resize();
            ...
            _getNearPlaneIntersections(e, t, i) {
                ...
                if (i.length === 1)
                    i[0] === 0
                        ? ((t[0] = this._getIntersection(t[1], le.set(0.95, 1, 0).applyMat4(r))), t.push(this._getIntersection(t[3], de.set(-1, -0.95, 0).applyMat4(r))))
                        : i[0] === 1
                        ? ((t[1] = this._getIntersection(t[0], le.set(-0.95, 1, 0).applyMat4(r))), t.push(this._getIntersection(t[2], de.set(1, -0.95, 0).applyMat4(r))))
                        : i[0] === 2
                        ? ((t[2] = this._getIntersection(t[3], le.set(-0.95, -1, 0).applyMat4(r))), t.push(this._getIntersection(t[1], de.set(1, 0.95, 0).applyMat4(r))))
                        : i[0] === 3 && ((t[3] = this._getIntersection(t[2], le.set(0.95, -1, 0).applyMat4(r))), t.push(this._getIntersection(t[0], de.set(-1, 0.95, 0).applyMat4(r))));
                else if (i.length === 2)
                    i[0] === 0 && i[1] === 1
                        ? ((t[0] = this._getIntersection(t[3], le.set(-1, -0.95, 0).applyMat4(r))), (t[1] = this._getIntersection(t[2], de.set(1, -0.95, 0).applyMat4(r))))
                        : i[0] === 1 && i[1] === 2
                        ? ((t[1] = this._getIntersection(t[0], le.set(-0.95, 1, 0).applyMat4(r))), (t[2] = this._getIntersection(t[3], de.set(-0.95, -1, 0).applyMat4(r))))
                        : i[0] === 2 && i[1] === 3
                        ? ((t[2] = this._getIntersection(t[1], le.set(1, 0.95, 0).applyMat4(r))), (t[3] = this._getIntersection(t[0], de.set(-1, 0.95, 0).applyMat4(r))))
                        : i[0] === 0 && i[1] === 3 && ((t[0] = this._getIntersection(t[1], le.set(0.95, 1, 0).applyMat4(r))), (t[3] = this._getIntersection(t[2], de.set(0.95, -1, 0).applyMat4(r))));
                else if (i.length === 3) {
                    let a = 0;
                    for (let n = 0; n < e.length; n++) i.includes(n) || (a = n);
                    (t = [t[a]]),
                        a === 0
                            ? (t.push(this._getIntersection(t[0], le.set(-0.95, 1, 0).applyMat4(r))), t.push(this._getIntersection(t[0], de.set(-1, 0.95, 0).applyMat4(r))))
                            : a === 1
                            ? (t.push(this._getIntersection(t[0], le.set(0.95, 1, 0).applyMat4(r))), t.push(this._getIntersection(t[0], de.set(1, 0.95, 0).applyMat4(r))))
                            : a === 2
                            ? (t.push(this._getIntersection(t[0], le.set(0.95, -1, 0).applyMat4(r))), t.push(this._getIntersection(t[0], de.set(1, -0.95, 0).applyMat4(r))))
                            : a === 3 && (t.push(this._getIntersection(t[0], le.set(-0.95, -1, 0).applyMat4(r))), t.push(this._getIntersection(t[0], de.set(-1 - 0.95, 0).applyMat4(r))));
            ...
            _computeWebGLBoundingRect() {
                let e = this._getWorldCoords(),
                    t = { top: 1 - (e.top + 1) / 2, right: (e.right + 1) / 2, bottom: 1 - (e.bottom + 1) / 2, left: (e.left + 1) / 2 };
            ...
            _shouldDrawCheck() {
                ...
                Math.round(e.top) >= this.renderer._boundingRect.top + this.renderer._boundingRect.height
                    ? this._shouldDraw && ((this._shouldDraw = !1), this.renderer.nextRender.add(() => this._onLeaveViewCallback && this._onLeaveViewCallback()))
                    : (this._shouldDraw || this.renderer.nextRender.add(() => this._onReEnterViewCallback && this._onReEnterViewCallback()), (this._shouldDraw = !0));
            }
            isDrawn() {
            ...
            _initSources() {
                ...
                if (this.autoloadSources) {
                    ...
                    t.length && this.loadImages(t), i.length && this.loadVideos(t), r.length && this.loadCanvases(t), (e = t.length + i.length + r.length);
                }
            ...
            mouseToPlaneCoords(e) {
                if ((or.setAxisOrder(this.quaternion.axisOrder), or.equals(this.quaternion) && Ha.equals(this.transformOrigin))) return super.mouseToPlaneCoords(e);
                {
                    let t = { x: 2 * (e.x / (this.renderer._boundingRect.width / this.renderer.pixelRatio)) - 1, y: 2 * (1 - e.y / (this.renderer._boundingRect.height / this.renderer.pixelRatio)) - 1 },
    ...
    var Se = class {
        constructor(e, { shaderPass: t, depth: i = !1, clear: r = !0, minWidth: a = 1024, minHeight: n = 1024, texturesOptions: o = {} } = {}) {
            (this.type = "RenderTarget"),
                ...
                (this._depth = i),
                (this._shouldClear = r),
                (this._minSize = { width: a * this.renderer.pixelRatio, height: n * this.renderer.pixelRatio }),
                (o = Object.assign(
                    {
        ...
        _createFrameBuffer() {
            (this._frameBuffer = this.gl.createFramebuffer()),
                ...
                this.textures.length ? ((this.textures[0]._parent = this), this.textures[0]._restoreContext()) : new ae(this.renderer, this._texturesOptions).addParent(this),
    ...
    var vt = class extends yt {
        ...
        _initShaderPass() {
            this.target ? (this.setRenderTarget(this.target), (this.target._shaderPass = this)) : this._createFrameBuffer(),
                new ae(this.renderer, { sampler: "uRenderTexture", isFBOTexture: !0, fromTexture: this.target.getTexture() }).addParent(this),
                this.loader._setLoaderSize(0),
                (this._canDraw = !0),
                this.renderer.needRender();
        }
        _createFrameBuffer() {
            let e = new Se(this.renderer, { shaderPass: this, clear: this._shouldClear, depth: this._depth, texturesOptions: this._texturesOptions });
            ...
            this._canDraw &&
                ...
                this._isScenePass
                    ? this.renderer.state.scenePassIndex + 1 < this.renderer.scene.stacks.scenePasses.length
                        ? (this.renderer.bindFrameBuffer(this.renderer.scene.stacks.scenePasses[this.renderer.state.scenePassIndex + 1].target), this.renderer.state.scenePassIndex++)
                        : this.renderer.bindFrameBuffer(null)
    ...
    var Yt = class {
        constructor({
            ...
            (this.plane = e),
                ...
                (this.content = { verticalAlign: r, text: this.textElement.textContent.replace(/[\n\r]+|[\s]{2,}/g, " ").trim() }),
                (this.canvas = document.createElement("canvas")),
                ...
                this.plane.loadCanvas(this.canvas, l, (g) => {
                    (this.texture = g), (this.texture.shouldUpdate = !1), this.content.fontLoaded && !this.content.firstWrite && this.writeTexture();
                }),
        ...
        setWords() {
            ...
            e.forEach((r, a) => {
                ...
                t.forEach((r) => {
                    let a = r.split(" ");
                    a.forEach((n, o) => {
                        this.content.words.push({ word: n, spaceAfter: !(n === "-" || o === a.length - 1 || n === "") });
                    });
                });
        }
        loadFont() {
            this.skipFontLoading
                ...
                : document.fonts.load(this.content.style.fontStyle + " " + this.content.style.fontWeight + " 1em " + this.content.style.fontFamily).then(() => {
                      (this.content.fontLoaded = !0), this.texture && !this.content.firstWrite && (this.plane.resize(), this.writeTexture());
                  });
        }
        writeTexture(e = !0) {
            ...
            (e || !this.lines) &&
                ...
                this.content.words.forEach((c, p) => {
                    ...
                    this.onAfterWordMeasuring && this.onAfterWordMeasuring(this.context, c, p),
                        ((p > 0 && l.x + f > this.content.innerBoundingRect.width + this.content.innerBoundingRect.left + a * this.allowedLineEndSpace) || c.word === "") && ((l.x = t), (l.y += i)),
                        l.x === t && this.lines.push([]),
                        this.lines[this.lines.length - 1].push({ word: c.word, wordWidth: f, position: { x: l.x, y: l.y }, spaceAfter: c.spaceAfter }),
                        (l.x += f),
                        c.spaceAfter && (l.x += a);
                }));
            let h = { x: 0, y: 0 },
                d = this.lines[0][0].position.y + this.lines[this.lines.length - 1][0].position.y + r;
            this.content.verticalAlign === "center" ? (h.y = (this.content.innerBoundingRect.height - d) * 0.5 - o * 0.5) : this.content.verticalAlign === "bottom" && (h.y = this.content.innerBoundingRect.height - d + o * 0.5),
                this.lines.forEach((c, p) => {
                    c.forEach((f) => {
                        ...
                        this.content.style.textAlign === "right" || this.content.style.textAlign === "end"
                            ...
                            : this.content.style.textAlign === "center" && (h.x = (this.content.innerBoundingRect.right - u) / 2),
                            this.onBeforeWordWriting &&
                                this.onBeforeWordWriting(this.context, f, { left: f.position.x + h.x, top: f.position.y + h.y, right: f.position.x + h.x + f.wordWidth, bottom: f.position.y + h.y + r }, this.content.style, p),
                            this.content.style.fillType === "stroke"
                                ? ((this.context.miterLimit = 2), this.context.strokeText(f.word, f.position.x + h.x, f.position.y + h.y))
...
`,
    ...
    var Gi = class {
        constructor({ container: e = "canvas", production: t = !1, width: i = 0, height: r = 0, smoothScroll: a, isMobile: n, onWebGLLayerError: o = () => {}, onWebGLSuccess: l = () => {} }) {
            (this.production = t),
                (this.smoothScroll = a),
                (this.isMobile = n),
                ...
                (this.curtains = new Wt({ container: e, pixelRatio: Math.min(1.5, window.devicePixelRatio), autoRender: !1, autoResize: !1, antialias: !1, production: this.production, watchScroll: !1 })),
                this.curtains
                    .onSuccess(() => {
                        (this.scroll = { value: 0, lastValue: 0, effect: 0 }),
                            (this.mouse = { last: new N(), current: new N(), velocity: new N(), updateVelocity: !1, lastTime: null }),
        ...
        onResize(e) {
            (this.width = e.width), (this.height = e.height), (this.isPortrait = e.width < e.height), this.curtains.resize();
        }
        onRender() {
            this.curtains.render();
        }
        onScroll(e) {
            this.curtains.updateScrollValues(0, e.current), this.scrollPass && e.velocity && (this.scrollPass.uniforms.scrollEffect.value = Math.max(-30, Math.min(30, e.velocity / 2)));
        }
        onMouseMove(e) {
            if (this.ripples) {
                ...
                if (((this.ripples.uniforms.mousePosition.value = t), this.mouse.updateVelocity)) {
                    ...
                    (this.mouse.lastTime = i), this.mouse.velocity.set((this.mouse.current.x - this.mouse.last.x) / r, (this.mouse.current.y - this.mouse.last.y) / r);
                }
            }
        }
        addRipples() {
            (this.ripples = new Xt(this.curtains, document.getElementById("ripples"), {
                ...
                uniforms: {
                    ...
                    resolution: { name: "uResolution", type: "2f", value: new N(this.size.width, this.size.height) },
                    ...
                    dissipation: { name: "uDissipation", type: "1f", value: this.isPortrait ? 0.985 : 0.9875 },
                },
            })),
                this.ripples
                    .onRender(() => {
                    ...
                    .onAfterResize(() => {
                        ...
                        this.ripples.uniforms.resolution.value.set(e.width, e.height), (this.ripples.uniforms.dissipation.value = this.isPortrait ? 0.985 : 0.9875);
                    });
        }
        addRenderPasses() {
            (this.scrollTarget = new Se(this.curtains)),
                (this.scrollPass = new vt(this.curtains, {
                    ...
                    depth: !1,
                    uniforms: { scrollEffect: { name: "uScrollEffect", type: "1f", value: this.scroll.effect }, scrollStrength: { name: "uScrollStrength", type: "1f", value: this.isPortrait ? 3 : 1.5 } },
                })),
                this.scrollPass
                    .onRender(() => {
                        this.smoothScroll ||
            ...
            this.curtains.isWebGL2() && ((t.vertexShader = Tr), (t.fragmentShader = Pr)),
                ...
                this.renderPass.createTexture({ sampler: "uRipplesTexture", fromTexture: this.ripples.getTexture() });
        }
        addPlanes() {
                ...
                e.type !== "PingPongPlane" &&
                    ...
                    e.userData.links &&
                        e.userData.links.forEach((t) => {
                            t.el.removeEventListener("mouseenter", t.mouseEnter), t.el.removeEventListener("mouseleave", t.mouseLeave);
                        }),
        ...
        addHeaderLinkPlanes() {
            document.querySelectorAll("#header .header-plane").forEach((e) => {
                let t = e.classList.contains("header-link"),
                    i = new be(this.curtains, e, { vertexShader: Wi, fragmentShader: ji, watchScroll: !1, uniforms: { fadeIn: { name: "uFadeIn", type: "1f", value: 0 } } });
                (i.userData.fadeDuration = 1.75), (i.userData.name = "homeLink"), (i.userData.isHovered = !1), t && (e.innerText = e.textContent.split(" ").join('"'));
                let r = (n, o, l) => {
                        o.word.indexOf('"') !== -1 && (o.word = o.word.replace(/\"/g, " ")),
                            (n.fillStyle = this.textColor),
                            (n.strokeStyle = this.textColor),
                            (n.lineWidth = 2),
                            i.userData.isHovered && (n.beginPath(), n.moveTo(l.left, l.bottom), n.lineTo(l.right, l.bottom), n.stroke());
                    },
                    a = new Yt({ plane: i, textElement: i.htmlElement, sampler: "uTexture", skipFontLoading: !0, onBeforeWordWriting: r, resolution: 1.5 });
                t &&
                    !this.isMobile &&
                ...
                (h.userData.links = []),
                    ...
                    (d = (f, u, g) => {
                        ...
                        _ &&
                            ...
                            (f.lineWidth = 2),
                            _.isHovered || (f.beginPath(), f.moveTo(g.left, g.bottom - 1), f.lineTo(g.right, g.bottom - 1), f.stroke()),
            ...
            o &&
                ...
                this.isMobile ||
                    ((h.userData.mouseEnter = () => {
                        (h.userData.isHovered = !0), h.userData.textTexture && h.userData.textTexture.writeTexture(!1);
                    }),
                    (h.userData.mouseLeave = () => {
                        (h.userData.isHovered = !1), h.userData.textTexture && h.userData.textTexture.writeTexture(!1);
                    }),
                ...
                (d = (p, f, u) => {
                    (p.fillStyle = this.textColor), h.userData.isHovered && ((p.strokeStyle = this.textColor), (p.lineWidth = 2), p.beginPath(), p.moveTo(u.left, u.bottom - 1), p.lineTo(u.right, u.bottom - 1), p.stroke());
                }));
            let c = new Yt({ plane: h, textElement: h.htmlElement, sampler: "uTexture", resolution: 1.5, skipFontLoading: !0, allowedLineEndSpace: l ? 2 : 0.5, onBeforeWordWriting: d });
        ...
        addSingleHRPlane(e) {
            let t = e.classList.contains("site-list-separator") || e.classList.contains("project-separator") ? 0.5 : 1,
                i = new be(this.curtains, e, { vertexShader: cr, fragmentShader: fr, uniforms: { fadeIn: { name: "uFadeIn", type: "1f", value: 0 }, opacity: { name: "uOpacity", type: "1f", value: t } } });
                ...
                i &&
                    ...
                    this.isMobile ||
                        ...
                        (n.userData.mouseEnter = () => {
                            (n.userData.isHovered = !0), this.isPortrait || (n.visible = !0), n.userData.tween && (n.userData.tween.kill(), (n.userData.tween = null));
                            let o = { opacity: n.uniforms.opacity.value, hoverEffect: n.uniforms.hoverEffect.value, textScale: n.textures[0].scale.x };
                            n.userData.tween = ee.to(o, {
                                ...
                                ease: "back.out",
                                onUpdate: () => {
                                    this.isPortrait || ((n.uniforms.opacity.value = o.opacity), (n.uniforms.hoverEffect.value = o.hoverEffect), (n.textures[0].scale.x = o.textScale), (n.textures[0].scale.y = o.textScale));
                                },
                                onComplete: () => {
                    ...
                    n.onAfterResize(() => {
                        this.isPortrait ? ((n.userData.isHovered = !1), (n.uniforms.opacity.value = 1)) : ((n.userData.isHovered = !1), (n.uniforms.opacity.value = n.userData.minOpacity));
                    }));
        }
        addVideoPlanes() {
        ...
        addSingleVideoPlane(e) {
            let t = new be(this.curtains, e, {
                ...
                heightSegments: 10,
                autoloadSources: !1,
                uniforms: { fadeIn: { name: "uFadeIn", type: "1f", value: 0 }, videoStarted: { name: "uVideoStarted", type: "1f", value: 0 } },
            });
            t.setRenderTarget(this.scrollTarget),
                (t.userData.fadeDuration = 1.75),
                (t.userData.shown = !1),
                (t.userData.videoLoaded = !1),
                t.loadImage(e.querySelector("img").getAttribute("data-video-poster"), { sampler: "videoPoster" }),
    ...
    var Hi = class {
        constructor({ container: e, inertia: t = 0.1, threshold: i = 0.5, useRaf: r = !1 } = {}) {
            ...
            (this.inertia = t), (this.threshold = i), (this._useRaf = r), (this._raf = null), (this._isScrolling = !1), (this.scroll = {}), (this.store = {}), this.resize(), this.init();
        }
        init() {
        ...
        update() {
            (this.store.documentHeight = this.container.clientHeight), (this.store.windowHeight = window.innerHeight), (document.body.style.height = this.store.documentHeight + "px");
        }
        resize() {
            this.update();
        ...
        emitScroll() {
            this.onScrollCallback && this.onScrollCallback({ current: this.scroll.current, target: this.scroll.target, velocity: this.scroll.velocity });
        }
        scrollTo(e) {
        ...
        render() {
            ...
            (this.scroll.current = this.lerp(this.scroll.current, this.scroll.target, this.inertia)),
                ...
                Math.abs(this.scroll.current - this.scroll.target) >= this.threshold
                    ...
                    : this._isScrolling && ((this._isScrolling = !1), (this.scroll.current = this.scroll.target), (this.scroll.velocity = 0), this.updatePosition(), this.emitScroll());
        }
        animate() {
        ...
        destroy() {
            this._raf && window.cancelAnimationFrame(this._raf), window.removeEventListener(this.scrollEvent);
        }
    };
    var Rr = class {
            constructor({ production: e = !1, analyticsID: t, appContainer: i, webglContainer: r, transitionDuration: a = 1e3 }) {
                (this.production = e),
                    (this.state = {
                        loader: { el: document.getElementById("loader"), startTs: (performance || Date).now(), loaded: !1, minDuration: 1e3 },
                        ...
                        hasObserver: !0,
                        namespace: "home",
                        fonts: { loaded: 0, list: ['normal 400 1em "MonumentExtended Regular", Arial, sans-serif', 'normal 400 1em "MonumentExtended UltraBold", Arial, sans-serif', 'normal 400 1em "Swiss", serif'] },
                    }),
                    this.checkPerf(),
            ...
            init() {
                this.initStore(),
                    ...
                    this.loadFonts(),
                    this.production &&
                        (console.log("%cHey there fellow dev friend!", 'font-size: 14px; color: #111111; font-weight: 700; font-family: "Swiss", Arial, sans-serif;'),
            ...
            loadFonts() {
                this.state.fonts.list.forEach((e) => {
                    document.fonts.load(e).then(() => {
                        this.state.fonts.loaded++, this.state.fonts.loaded === this.state.fonts.list.length && this.onCurtainsReady();
                    });
                });
            }
            onWebGLLayerError() {
                (this.state.hasWebgl = !1), (this.webglLayer = null), document.body.classList.add("reduced-motion");
            }
            onWebGLSuccess() {
                (this.state.hasWebgl = !0), document.body.classList.add("has-webgl"), this.onCurtainsReady();
            }
            checkPerf() {
                this.perf = 0;
                ...
                window.location.href.indexOf("no-motion") !== -1 ? (r = !1) : window.location.href.indexOf("no-webgl") !== -1 && (this.perf = this.state.webglPerfThreshold + 1),
                    !r || r.matches ? ((this.perf = 6), document.body.classList.add("no-motion")) : this.perf > this.state.webglPerfThreshold && document.body.classList.add("reduced-motion");
            }
            startServiceWorker() {
                "serviceWorker" in navigator && navigator.serviceWorker.register( new URL('service-worker.js', import.meta.url),
                {type: 'module'});
            }
            initAnalytics() {
                this.analyticsID &&
                    ...
                    this.perf >= 6
                        ? this.gtag("event", "load", { event_category: "Version displayed", event_label: "No motion", non_interaction: !0 })
                        : this.perf > this.state.webglPerfThreshold && this.gtag("event", "load", { event_category: "Version displayed", event_label: "No WebGL", non_interaction: !0 }));
            }
            initStore() {
                let e = window.innerWidth,
                    t = window.innerHeight;
                this.store = { windowWidth: e, windowHeight: t, mouse: { current: { x: 0, y: 0 } }, scroll: { x: 0, y: 0 }, pageTweens: [] };
            }
            initEventsEmitters() {
            ...
            emitEvent(e, t = {}) {
                for (let i = 0; i < this.listeners[e].length; i++) this.listeners[e][i].callback && this.listeners[e][i].callback(t);
            }
            onResize() {
                let e = window.innerWidth,
                    t = this.state.isMobile && this.store.windowWidth === e;
                (this.store.windowWidth = e), (this.store.windowHeight = window.innerHeight), t || this.emitEvent("resize", { width: this.store.windowWidth, height: this.store.windowHeight });
            }
            onScroll(e) {
            ...
            onMouseMove(e) {
                e.targetTouches ? (this.store.mouse.current = { x: e.targetTouches[0].clientX, y: e.targetTouches[0].clientY }) : (this.store.mouse.current = { x: e.clientX, y: e.clientY }),
                    this.emitEvent("mouse", this.store.mouse.current);
            }
            onWindowLoad() {
                window.addEventListener("resize", this.onResize.bind(this)),
                    !this.state.isMobile && this.perf < 6
                        ? ((this.smoothScroll = new Hi({ container: document.getElementById(this.appContainer) })),
                          this.smoothScroll.onScroll((e) => {
                              this.onScroll(e);
                          }),
                          this.addEvents({ resize: this.smoothScroll.resize.bind(this.smoothScroll), render: this.smoothScroll.render.bind(this.smoothScroll) }),
                    ...
                    this.perf < 6 && (this.startRouting(), this.setObserver({ name: "main", threshold: 0 }), ee && ee.ticker.add(this.onRender.bind(this))),
                    this.onPageLoad();
            }
            onCurtainsReady() {
                    ...
                    onReady: {
                        value: (e, t) => {
                            this.smoothScroll && this.smoothScroll.update(),
                                ...
                                this.analyticsID && this.gtag && this.production && this.gtag("config", this.analyticsID, { page_path: window.location.pathname });
                        },
                    },
                    onWaiting: {
                        value: (e, t) => {
            ...
            onPageLoad() {
                if ((this.setNameSpace(), this.webglLayer && this.state.loader.loaded && this.webglLayer.addPlanes(), !this.state.loader.loaded)) {
                    let e = (performance || Date).now(),
                        t = e - this.state.loader.startTs > this.state.loader.minDuration ? 0 : this.state.loader.minDuration - (e - this.state.loader.startTs);
                    setTimeout(() => {
                        this.perf > this.state.webglPerfThreshold && (this.state.loader.el.classList.remove("shown"), this.startMainObserver());
                    }, t);
                }
            ...
            afterPageLoad() {
                this.webglLayer &&
                    ((this.webglLayer.renderPass.uniforms.transitionDirection.value = -1), ee.to(this.webglLayer.renderPass.uniforms.pageTransition, { value: 0, duration: this.transitionDuration / 1e3, ease: "power3.inOut" })),
                    setTimeout(() => {
            ...
            beforePageUnload(e, t) {
                this.webglLayer
                    ? ((this.webglLayer.renderPass.uniforms.transitionDirection.value = 1), ee.to(this.webglLayer.renderPass.uniforms.pageTransition, { value: 1, duration: this.transitionDuration / 1e3, ease: "power3.inOut" }))
            ...
            onPageUnload() {
                for (let e = 0; e < this.store.pageTweens.length; e++) this.store.pageTweens[e].kill(), (this.store.pageTweens[e] = null);
                (this.store.pageTweens = []), window.scrollTo(0, 0), this.webglLayer && this.webglLayer.removePlanes();
            }
            scrollToTop() {
                if (this.perf < 6) {
                ...
                this.state.scrollTopButton &&
                    ...
                    setTimeout(() => {
                        this.state.scrollTopButton && (this.state.scrollTopButton.classList.remove("clicked"), this.state.scrollTopButton.blur());
                    }, 1e3));
            }
            setObserver({ name: e, root: t, rootMargin: i, threshold: r = [0, 0.25, 0.5, 0.75, 1] }) {
                this.observers[e || "observer-" + this.observers.length] = new Mi({ threshold: r, root: t, rootMargin: i }).onError(() => {
                    ...
                    ? this.webglLayer.curtains.planes.forEach((e) => {
                          if (e && !e.userData.shown) {
                              let t = ee.to(e.uniforms.fadeIn, {
                                  ...
                                  onComplete: () => {
                                      (e.userData.shown = !0), e.userData.shown && e.userData.videoLoaded && e.playVideos();
                                  },
                              });
                        ...
                        onBeforeElVisible: (e) => {
                            e.el.classList.contains("main-title-text") && (e.stagger = 100),
                                e.el.classList.contains("site-list-separator")
                                    ? (e.stagger = 0)
                                    : e.el.closest(".site-list-right-content") || e.el.closest(".site-list-left-content")
                                    ? (e.stagger = 50)
                            ...
                            if (this.webglLayer) {
                                ...
                                if (t && !t.userData.shown) {
                                    let i = ee.to(t.uniforms.fadeIn, {
                                        ...
                                        onComplete: () => {
                                            (t.userData.shown = !0), t.userData.shown && t.userData.videoLoaded && t.playVideos();
                                        },
                                    });
                                ...
                                let t = e.el.classList.contains("main-title-text"),
                                    ...
                                    o = i
                                        ? ee.fromTo(e.el, { autoAlpha: 0, scaleX: 0, transformOrigin: "0 50%" }, { autoAlpha: 1, scale: 1, scaleX: 1, duration: 1.5, ease: "power4.out" })
                                        : ee.fromTo(
                                              e.el,
        ...
        $h = new Rr({ analyticsID: "UA-29368338-1", production: !0, appContainer: "page", webglContainer: "canvas", transitionDuration: 1500 });
})();
/*!
 * CSSPlugin 3.6.0
 * https://greensock.com
